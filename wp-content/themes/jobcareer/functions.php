...
if (!function_exists('jobcareer_setup')) {
    ...
    function jobcareer_setup() {
         ...
         * wp_enqueue_scripts
         */
        add_action('wp_enqueue_scripts', 'jobcareer_front_scripts');
...
function jobcareer_body_classes($classes) {
    ...
    if (isset($jobcareer_options['cs_style_rtl']) and $jobcareer_options['cs_style_rtl'] == 'on') {
        $cs_rtl_cls = 'rtl';
    } else {
        $cs_rtl_cls = '';
    }
    ...
    function jobcareer_front_scripts() {
        ...
        if (!is_admin()) {
            ...
            if (isset($jobcareer_options['cs_maintenance_page_switch']) and $jobcareer_options['cs_maintenance_page_switch'] == 'on') {
                wp_enqueue_script('jobcareer_addthis_widget_js', 'http://s7.addthis.com/js/250/addthis_widget.js#pubid=xa-4e4412d954dccc64', '', '', true);
            }
            ...
            if (!function_exists('jobcareer_google_map_script')) {
                ...
                function jobcareer_google_map_script() {
                    wp_enqueue_script('jobcareer_google_autocomplete_script', 'http://maps.google.com/maps/api/js?sensor=false&libraries=places', '', '', true);
                }
            ...
            if (!function_exists('jobcareer_addthis_script_init_method')) {
                ...
                function jobcareer_addthis_script_init_method() {
                    wp_enqueue_script('jobcareer_addthis_widget_js', 'http://s7.addthis.com/js/250/addthis_widget.js#pubid=xa-4e4412d954dccc64');
                }
 ...
 */
if (!function_exists('jobcareer_query_vars')) {

    function jobcareer_query_vars($query) {
...
// End change the default query variable...
...
/*
 * Start display post page title function 
 */
if (!function_exists('jobcareer_post_page_title')) {

    function jobcareer_post_page_title() {
        if (is_author()) {
            global $author;
...
// End  display post page title function
...
if (!function_exists('jobcareer_get_excerpt')) {
    ...
    function jobcareer_get_excerpt($charlength = '255', $readmore = 'true', $readmore_text = 'Read More') {
...
if (!function_exists('jobcareer_pb_element_sizes')) {
    ...
    function jobcareer_pb_element_sizes($size = '100') {
        ...
        if (isset($element_size_col) and $element_size_col == '100' || $element_size_col > 75) {
            ...
            $element_size = 'col-lg-8 col-md-12 col-sm-12 col-xs-12';
...
if (!function_exists('jobcareer_contact_form_submit')) {
    ...
    function jobcareer_contact_form_submit() {
        ...
        $attachments = '';
        mail($cs_contact_email, sanitize_email($contact_email), $message, $headers, '');
        if ($contact_email) {
            $json = array();
            $json['type'] = "success";
...
if (!function_exists('jobcareer_slider_form_submit')) {
    ...
    function jobcareer_slider_form_submit() {
        ...
        $headers = "From: " . $slider_name . "\r\n";
        $headers .= "Reply-To: " . $slider_mail . "\r\n";
        $headers .= "Content-type: text/html; charset=utf-8" . "\r\n";
        $headers .= "MIME-Version: 1.0" . "\r\n";
        $attachments = '';

        if (wp_mail(sanitize_email($cs_slider_email), sanitize_email($subjecteEmail), $message, $headers, $attachments)) {
            $json = array();
            $json['type'] = "success";
                                ...
                                <div class="thumblist">
                                    ...
                                    <div class="cs-text">
                                        <div class="cs-author-info">
                                            ...
                                            <?php comment_reply_link(array_merge($args, array('depth' => $depth, 'reply_text' => 'Reply'))); ?>
                                        </div>
...
// End Breadcrums functions here
    ...
    if (!function_exists('jobcareer_footer_logo')) {
        ...
        function jobcareer_footer_logo() {
            ...
            $logo = isset($jobcareer_options['cs_footer_logo']) ? $jobcareer_options['cs_footer_logo'] : '';
