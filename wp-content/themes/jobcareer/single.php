                            ...
                            <div class="cs-blog-detail">
                                    ...
                                    if ($inside_post_view == "slider") {
                                        ...
                                        if ($url['host'] == $_SERVER["SERVER_NAME"]) {
                                            ...
                                            if ($url['host'] == 'vimeo.com') {
                                                ...
                                                echo '<div class="cs-main-post"><figure>' . $cs_iframe . ' width="' . $width . '" height="' . $height . '" src="https://player.vimeo.com/video/' . $content_vimo . '" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe></figure></div>';
                                ...
                                <div class="cs-post-title">
                                    ...
                                    <div class="post-option">
                                        ...
                                        <span class="post-comment"><a href="<?php the_permalink(); ?>#comments"><i class="cs-color icon-chat6"></i><?php echo comments_number('0 ', '1 Comment', '% Comments'); ?></a></span>
                                    </div>
                                </div>
                                ...
                                if (isset($cs_related_post) && $cs_related_post == 'on') {
                                    ...
                                    if (!empty($cat_arr)) {
                                        // global $post, $cs_blog_cat, $cs_blog_description, $cs_blog_excerpt, $cs_notification, $wp_query, $cs_blog_grid_layout, $cs_blog_section_title;
                                        $cs_blog_excerpt = '50';
                                        $width = '236';
                                        $height = '168';
