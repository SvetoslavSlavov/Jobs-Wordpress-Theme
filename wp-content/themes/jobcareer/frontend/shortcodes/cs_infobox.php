...
if (!function_exists('jobcareer_infobox_shortcode')) {
    ...
    function jobcareer_infobox_shortcode($atts, $content = "") {
        ...
        $html .= '<div class="cs-section-title"><h2>' . $cs_infobox_title . '</h2></div>';
        $html .='<ul>';
...
if (!function_exists('cs_infobox_item_shortcode')) {
    ...
    function cs_infobox_item_shortcode($atts, $content = "") {
        ...
        $defaults = array('cs_infobox_list_icon' => '', 'cs_infobox_list_color' => '', 'cs_infobox_list_title' => '', "cs_infobox_list_text_color" => '');
        extract(shortcode_atts($defaults, $atts));
        ...
        $html .= '<li>
                    <div class="contact-icon"><span class="' . $cs_infobox_list_icon . '" ' . $cs_infobox_icon_color_style . '></span></div>
                    <div class="contact-label">
						<p  style="color:' . $cs_infobox_list_text_color . '">
						  <strong >' . $cs_infobox_list_title . '</strong>
						  <span style="color:' . $cs_infobox_list_text_color . ' !impotant;">
