...
if (!function_exists('jobcareer_testimonials_shortcode')) {
    ...
    function jobcareer_testimonials_shortcode($atts, $content = null) {
        global $testimonial_style, $cs_testimonial_class, $column_class, $testimonial_text_color, $testimonial_author_color, $testimonial_comp_color, $section_title, $post;
        $randomid = rand(0, 999);
        $defaults = array('column_size' => '1/1', 'testimonial_style' => '', 'testimonial_text_color' => '', 'testimonial_author_color' => '', 'testimonial_comp_color' => '', 'testimonial_border' => '', 'testimonial_text_color' => '', 'cs_testimonial_text_align' => '', 'cs_testimonial_section_title' => '', 'cs_testimonial_class' => '');
        ...
        if (isset($testimonial_style) and $testimonial_style == 'simple') {
            ...
            $html .= '</ul>';
            $html .= '</section>';
        } elseif (isset($testimonial_style) and $testimonial_style == 'slider-small') {

            $html = '<section class="testimonial-inner slider-small">';
            $html .= '<ul class="testimonial-home slider' . $randomid . $cs_border_class . '">';
            $html .= do_shortcode($content);
            $html .= '</ul>';
            $html .= '</section>';
