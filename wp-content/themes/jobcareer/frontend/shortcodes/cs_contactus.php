 ...
 *
 */
if (!function_exists('jobcareer_contactus_shortcode')) {

    function jobcareer_contactus_shortcode($atts, $content = "") {
        ...
        if ($cs_contactus_section_title && trim($cs_contactus_section_title) != '') {
            $section_title = '<div class="cs-section-title"><h2>' . $cs_contactus_section_title . '</h2></div>';
        }
        ...
        $cs_opt_array = array(
            'std' => esc_attr($cs_contactus_send),
            'id' => '',
            'before' => '',
            'after' => '',
            'classes' => '',
        ...
        $html .= $jobcareer_form_fields->cs_form_hidden_render($cs_opt_array);
        $html .= '<label class="profile-contact-btn pull-right">';
        $cs_opt_array = array(
    ...
    if (function_exists('cs_short_code')) {
        ...
        cs_short_code(CS_SC_CONTACTUS, 'jobcareer_contactus_shortcode');
    }
}