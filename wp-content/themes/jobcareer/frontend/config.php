...
define('CS_SC_MULTI_SERVICES', 'cs_multi_services');
define('CS_SC_MULTI_SERVICESITEM', 'cs_multi_services_item');
...
define('CS_SC_QUOTE_CHIMP', 'cs_quotes');
define('CS_SC_QUICK_QUOTE', 'cs_quick_slider');
//define('CS_SC_QUICK_QUOTE', 'cs_quick_quote');
...
define('CS_SC_MAILCHIMP', 'jobcareer_mailchimp');
//Translation
esc_html__('Call To Action', 'jobcareer');
esc_html__('Contactus', 'jobcareer');
