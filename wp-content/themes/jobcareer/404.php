                ...
                <div class="page-not-found">
                   ...
                   <div class="cs-spreater">
                    ...
                    <div class="cs-content404">
                        <div class="desc">
                            <p><?php esc_html_e('Unfortunately the page you were looking for could not be found. It may be temporarily unavailable, moved or no longer exist. <br> Check the Url you entered for any mistakes and try again.', 'jobcareer'); ?></p> 
                        </div>
