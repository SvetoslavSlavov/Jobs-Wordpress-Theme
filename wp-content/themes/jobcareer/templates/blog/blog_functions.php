...
if (!function_exists('jobcareer_blog_shortcode')) {
    ...
    function jobcareer_blog_shortcode($atts) {
        global $post, $wpdb, $jobcareer_options, $cs_counter_node, $jobcareer_column_atts, $cs_blog_cat, $cs_blog_description, $cs_blog_excerpt, $post_thumb_view, $cs_blog_section_title, $cs_exclude_post_id, $args;
        $defaults = array('cs_blog_section_title' => '', 'cs_blog_view' => '', 'cs_exclude_post_id' => '0', 'cs_blog_cat' => '', 'cs_blog_orderby' => 'DESC', 'orderby' => 'ID', 'cs_blog_description' => 'yes', 'cs_blog_excerpt' => '255', 'cs_blog_num_post' => '10', 'blog_pagination' => '', 'cs_blog_class' => '');
        ...
        if ($cs_blog_view == '3-slides') {
            get_template_part('templates/blog/blog', '3slides');
        } else if ($cs_blog_view == '4-slides') {
            get_template_part('templates/blog/blog', '4slides');
