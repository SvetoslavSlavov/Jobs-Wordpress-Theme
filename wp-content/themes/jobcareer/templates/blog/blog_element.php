        ...
        <div id="<?php echo esc_attr($name . $cs_counter); ?>_del" class="column  parentdelete <?php echo esc_attr($coloumn_class); ?> <?php echo esc_attr($shortcode_view); ?>" item="blog" data="<?php echo jobcareer_element_size_data_array_index($blog_element_size) ?>">
            ...
            <div class="cs-wrapp-class-<?php echo intval($cs_counter) ?> <?php echo esc_attr($shortcode_element); ?>" id="<?php echo esc_attr($name . $cs_counter) ?>" data-shortcode-template="[cs_blog {{attributes}}]"  style="display: none;">
                <div class="cs-heading-area">
                    <h5><?php esc_html_e('Edit Blog Items', 'jobcareer') ?></h5>
                ...
                <div class="cs-pbwp-content">
                    <div class="cs-wrapp-clone cs-shortcode-wrapp">
                        ...
                        $cs_opt_array = array(
                            ...
                            'desc' => '',
                            'hint_text' => esc_html__("Enter your blog section title here.", 'jobcareer'),
                            'echo' => true,
                            'field_params' => array(
                        ...
                        $cs_opt_array = array(
                            'name' => esc_html__('Blog Design Views', 'jobcareer'),
                            'desc' => '',
                            ...
                            'field_params' => array(
                                ...
                                'options' => array(
                                    ...
                                    '3-slides' => esc_html__('3 Slides', 'jobcareer'),
                                    '4-slides' => esc_html__('4 Slides', 'jobcareer'),
                        ...
                        <div id="Blog-listing<?php echo intval($cs_counter); ?>" >
                            <?php
                            $cs_opt_array = array(
                                'name' => esc_html__('Post Order', 'jobcareer'),
                                'desc' => '',
                                'hint_text' => esc_html__("Arranging posts in ascending order and descending order with this dropdown.", 'jobcareer'),
                                'echo' => true,
                                'field_params' => array(
                                    'std' => $cs_blog_orderby,
                                    'id' => '',
                            ...
                            $cs_opt_array = array(
                                'name' => esc_html__('Post Description', 'jobcareer'),
                                'desc' => '',
                            ...
                            $cs_opt_array = array(
                                'name' => esc_html__('Length of Excerpt', 'jobcareer'),
                                'desc' => '',
                                'hint_text' => esc_html__("Add number of excerpt character here for display on blog listing.", 'jobcareer'),
                                'echo' => true,
                                'field_params' => array(
