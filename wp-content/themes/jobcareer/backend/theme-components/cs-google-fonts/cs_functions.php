...
if (!function_exists('jobcareer_get_google_font_attributes')) {
    ...
    function jobcareer_get_google_font_attributes() {
        ...
        if ($index != 'default') {
            ...
            $html = '<select class="chosen-select" id="' . $_POST['id'] . '" name="' . $_POST['id'] . '"><option value="">Select Attribute</option>';
            foreach ($items as $key => $value) {
                $html .= '<option value="' . $value . '">' . $value . '</option>';
            }
            $html .='</select>';
        } else {
            $html = '<select class="chosen-select" id="' . $_POST['id'] . '" name="' . $_POST['id'] . '"><option value="">Select Attribute</option></select>';
        }
        $html .= '
	<script>
