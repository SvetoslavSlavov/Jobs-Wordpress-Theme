...
if (!function_exists('jobcareer_pb_faq')) {
    ...
    function jobcareer_pb_faq($die = 0) {
        ...
        <?php jobcareer_element_setting($name, $cs_counter, $faq_element_size, '', 'question-circle'); ?>
            <div class="cs-wrapp-class-<?php echo esc_attr($cs_counter) ?> <?php echo jobcareer_special_char($shortcode_element); ?>" id="<?php echo jobcareer_special_char($name . $cs_counter) ?>" data-shortcode-template="[<?php echo esc_attr(CS_SC_FAQ); ?> {{attributes}}]" style="display: none;">
                <div class="cs-heading-area">
                    <h5><?php esc_html_e('EDIT FAQ OPTIONS', 'jobcareer'); ?></h5>
        ...
        $cs_opt_array = array(
            ...
            'desc' => '',
            'hint_text' => esc_html__("Add FAQ section title here.", 'jobcareer'),
            'echo' => true,
            'field_params' => array(
        ...
        ?>
                                ...
                                $cs_opt_array = array(
                                    ...
                                    'echo' => true,
                                    'field_params' => array(
                                        'std' => jobcareer_special_char($faq_class),
                                        'cust_id' => '',
                        ...
                        <div class="wrapptabbox">
                            <div class="opt-conts">
                                <ul class="form-elements">
                                    <li class="to-field"> <a href="#" class="add_servicesss cs-main-btn" onclick="jobcareer_shortcode_element_ajax_call('faq', 'shortcode-item-<?php echo esc_js($cs_counter); ?>', '<?php echo esc_js(admin_url('admin-ajax.php')); ?>')"><i class="icon-plus-circle"></i><?php esc_html_e('Add Faq', 'jobcareer'); ?></a> </li>
