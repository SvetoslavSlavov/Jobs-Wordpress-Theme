        ...
        <div id="<?php echo esc_attr($name . $cs_counter) ?>_del" class="column  parentdelete <?php echo esc_attr($coloumn_class); ?> <?php echo esc_attr($shortcode_view); ?>" item="heading" data="<?php echo jobcareer_element_size_data_array_index($heading_element_size) ?>" >
            ...
            <div class="cs-wrapp-class-<?php echo intval($cs_counter) ?> <?php echo esc_attr($shortcode_element); ?>" id="<?php echo esc_attr($name . $cs_counter) ?>"  data-shortcode-template="[<?php echo esc_attr(CS_SC_HEADING); ?> {{attributes}}]{{content}}[/<?php echo esc_attr(CS_SC_HEADING); ?>]" style="display: none;">
                <div class="cs-heading-area">
                    <h5><?php esc_html_e('EDIT HEADING OPTIONS', 'jobcareer'); ?></h5>
                ...
                <div class="cs-pbwp-content">
                    <div class="cs-wrapp-clone cs-shortcode-wrapp">
                        ...
                        $cs_opt_array = array(
                            ...
                            'desc' => '',
                            'hint_text' => esc_html__("Enter heading subtext here", 'jobcareer'),
                            'echo' => true,
                            'field_params' => array(
                        ...
                        $cs_opt_array = array(
                            ...
                            'field_params' => array(
                                ...
                                'options' => array(
                                    ...
                                    'section_title' => esc_html__('Seaction Title', 'jobcareer'),
                                ),
                                'return' => true,
                            ),
                        );
                        ...
                        <div class="form-elements">
                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                <label><?php esc_html_e('Font Style', 'jobcareer'); ?></label>
                                <?php
                                if (function_exists('jobcareer_tooltip_text')) {
                                    echo jobcareer_tooltip_text(esc_html__('Add font style for heading here.', 'jobcareer'));
                                }
                                ?>
                            </div>
                            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                ...
                                $cs_opt_array = array(
                                    ...
                                    'extra_atr' => ' placeholder="Letter Spacing"',
                                    'return' => true,
                                    'required' => false,
                                    'rang' => true,
                                    'min' => 0,
                                ...
                                $cs_opt_array = array(
                                    ...
                                    'extra_atr' => ' placeholder="Line Height"',
                                    'return' => true,
                                    'required' => false,
                                    'rang' => true,
                                    'min' => 0,
                        ...
                        <?php
                        $cs_opt_array = array(
                            'name' => esc_html__('Align', 'jobcareer'),
                            'desc' => '',
                        ...
                        $cs_opt_array = array(
                            ...
                            'desc' => '',
                            'hint_text' => esc_html__("Choose heading content color with this color picker.", 'jobcareer'),
                            'echo' => true,
                            'field_params' => array(
                                'std' => esc_attr($heading_content_color),
                                'cust_id' => '',
                                'classes' => 'bg_color',
                                'cust_name' => 'heading_content_color[]',
                                'return' => true,
                            ),
                        );
