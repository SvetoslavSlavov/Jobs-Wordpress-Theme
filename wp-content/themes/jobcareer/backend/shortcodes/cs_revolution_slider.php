...
if (!function_exists('jobcareer_pb_slider')) {
    ...
    function jobcareer_pb_slider($die = 0) {
        ...
        <?php jobcareer_element_setting($name, $cs_counter, $slider_element_size, '', 'picture-o'); ?>
            <div class="cs-wrapp-class-<?php echo intval($cs_counter) ?> <?php echo esc_attr($shortcode_element); ?>" id="<?php echo esc_attr($name . $cs_counter) ?>" data-shortcode-template="[<?php echo esc_attr(CS_SC_SLIDER); ?> {{attributes}}]" style="display: none;">
                <div class="cs-heading-area">
                    <h5><?php esc_html_e('EDIT SLIDER OPTIONS', 'jobcareer'); ?></h5>
        ...
        <?php
        $cs_opt_array = array(
            'name' => esc_html__('Slider Section Title', 'jobcareer'),
            'desc' => '',
            'hint_text' => esc_html__('Enter Slider Section title here', 'jobcareer'),
            'echo' => true,
            'field_params' => array(
        ...
        $cs_opt_array = array(
            ...
            'desc' => '',
            'hint_text' => esc_html__("Choose revolution slider from here. If you have not any sldier create new with activating revolution lsider plugin.", 'jobcareer'),
            'echo' => true,
            'field_params' => array(
                'std' => $cs_slider_id,
