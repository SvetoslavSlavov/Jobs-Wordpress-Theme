    ...
    function jobcareer_pb_call_to_action($die = 0) {
        ...
        <div id="<?php echo esc_attr($name . $cs_counter) ?>_del" class="column  parentdelete <?php echo esc_attr($coloumn_class); ?> <?php echo esc_attr($shortcode_view); ?>" item="call_to_action" data="<?php echo jobcareer_element_size_data_array_index($call_to_action_element_size) ?>">
            ...
            <div class="cs-wrapp-class-<?php echo esc_attr($cs_counter) ?> <?php echo esc_attr($shortcode_element); ?>" id="<?php echo esc_attr($name . $cs_counter) ?>" data-shortcode-template="[<?php echo esc_attr(CS_SC_CALLTOACTION); ?> {{attributes}}]{{content}}[/<?php echo esc_attr(CS_SC_CALLTOACTION); ?>]" style="display: none;">
                <div class="cs-heading-area">
                    <h5><?php esc_html_e('Edit Call to Action options', 'jobcareer'); ?></h5>
                ...
                <div class="cs-pbwp-content">
                    <div class="cs-wrapp-clone cs-shortcode-wrapp cs-pbwp-content">
                        ...
                        $cs_opt_array = array(
                            ...
                            'desc' => '',
                            'hint_text' => esc_html__("Add Call to Action section title here", 'jobcareer'),
                            'echo' => true,
                            'field_params' => array(
                        ...
                        $cs_opt_array = array(
                            ...
                            'desc' => '',
                            'hint_text' => esc_html__("Put the title for call to action", 'jobcareer'),
                            'echo' => true,
                            'field_params' => array(
                        ...
                        $cs_opt_array = array(
                            ...
                            'desc' => '',
                            'hint_text' => esc_html__("Set a call to action style from the dropdown.", 'jobcareer'),
                            'echo' => true,
                            'field_params' => array(
                                'std' => $cs_call_action_view,
                                'id' => '',
                                'cust_id' => 'cs_call_action_view',
                                'cust_name' => 'cs_call_action_view[]',
                                'classes' => 'dropdown chosen-select-no-single select-medium',
                                'extra_atr' => ' onchange="hide_show_fields(this.value)"',
                                'options' => array(
                        ...
                        $cs_opt_array = array(
                            ...
                            'desc' => '',
                            'hint_text' => esc_html__("Enter short detail about your call to action content", 'jobcareer'),
                            'echo' => true,
                            'field_params' => array(
                        ...
                        $cs_opt_array = array(
                            ...
                            'desc' => '',
                            'hint_text' => esc_html__("Define call to action text color with this color picker", 'jobcareer'),
                            'echo' => true,
                            'field_params' => array(
                        ...
                        $display_bg = "display:block;";
                        if (isset($cs_call_action_view) && $cs_call_action_view == 'default') {
                            $display_color = "display:block;";
                        ...
                        $cs_opt_array = array(
                            ...
                            'desc' => '',
                            'hint_text' => 'Select the background image for action element.',
                            'echo' => true,
                            'array' => true,
                            'field_params' => array(
                                'std' => $cs_call_to_action_img,
                        ...
                        $cs_opt_array = array(
                            ...
                            'desc' => '',
                            'hint_text' => esc_html__("Set the button color for your call to action.", 'jobcareer'),
                            'echo' => true,
                            'field_params' => array(
						...
						$cs_opt_array = array(
                            ...
                            'field_params' => array(
								...
								'options' => array( 'left' => esc_html__('Left Align', 'jobcareer'),'right' => esc_html__('Right Align', 'jobcareer'),'center' => esc_html__('Center Align', 'jobcareer') ),
                                'return' => true,
                            ),
                        );
                        ...
                        $cs_opt_array = array(
                            ...
                            'echo' => true,
                            'field_params' => array(
                                'std' => esc_attr($cs_call_to_action_class),
                                'cust_id' => '',
                                'classes' => 'txtfield input-medium',
                                'cust_name' => 'cs_call_to_action_class[]',
                                'return' => true,
                            ),
                        );
        ...
        <script type="text/javascript">
            jQuery(document).ready(function ($) {
                ...
                // alert("here in edit after edit case");
            });
        </script>
