        ...
        if (isset($jobcareer_xmlObject->cs_post_author_info_show) && $jobcareer_xmlObject->cs_post_author_info_show == 'on') {
            ...
            <div class="cs-content-wrap">
                <header class="cs-heading-title">
                    <h2 class=" cs-section-title"><?php esc_html_e('About', 'jobcareer'); ?> <?php esc_html_e('Author', 'jobcareer'); ?></h2>
                </header>
...
if (!function_exists('jobcareer_shortcode_names')) {
    ...
    function jobcareer_shortcode_names() {
        ...
        $shortcode_array = array(
            ...
            'contactus' => array(
                'title' => esc_html__('Form', 'jobcareer'),
                'name' => 'contactus',
            ...
            'mailchimp' => array(
                'title' => esc_html__('Newslatter', 'jobcareer'),
                'name' => 'mailchimp',
                'icon' => 'icon-h-square',
                'categories' => 'typography misc',
            ),
            ...
            'multiple_services' => array(
                'title' => esc_html__('Multiple Services', 'jobcareer'),
            ...
            'quick_slider' => array(
                'title' => esc_html__('Quick Quote', 'jobcareer'),
                'name' => 'quick_slider',
            ...
            'services' => array(
                'title' => esc_html__('Services', 'jobcareer'),
                'name' => 'services',
            ...
            'multi_price_table' => array(
                'title' => esc_html__('Multi Price Table', 'jobcareer'),
                'name' => 'multi_price_table',
                'icon' => 'icon-comments-o',
                'categories' => 'typography misc',
            ),
            'multi_counters' => array(
                'title' => esc_html__('Multi Counters', 'jobcareer'),
                'name' => 'multi_counters',
                'icon' => 'icon-comments-o',
                'categories' => 'typography misc',
            ),
        ...
        if (class_exists('wp_jobhunt')) {
            ...
            $shortcode_array['cv_package'] = array(
                'title' => esc_html__('CV Package', 'jobcareer'),
                'name' => 'cv_package',
                'icon' => 'icon-table',
                'categories' => 'loops misc',
            );
            ...
            $shortcode_array['job_package'] = array(
                'title' => esc_html__('Job Package', 'jobcareer'),
                'name' => 'job_package',
                'icon' => 'icon-table',
                'categories' => 'loops misc',
            );
            ...
            $shortcode_array['job_specialisms'] = array(
                'title' => esc_html__('Job Specialisms', 'jobcareer'),
            ...
            $shortcode_array['jobs_search'] = array(
                'title' => esc_html__('Job Search', 'jobcareer'),
                'name' => 'jobs_search',
                'icon' => 'icon-table',
                'categories' => 'loops misc',
            );
            ...
            $shortcode_array['candidate'] = array(
                'title' => esc_html__('Candidate', 'jobcareer'),
                'name' => 'candidate',
                'icon' => 'icon-home',
                'categories' => 'loops misc',
            );
            ...
            $shortcode_array['employer'] = array(
                'title' => esc_html__('Employer', 'jobcareer'),
                'name' => 'employer',
                'icon' => 'icon-home',
                'categories' => 'loops misc',
            );
            ...
            $shortcode_array['jobcareer'] = array(
                'title' => esc_html__('Jobs', 'jobcareer'),
                'name' => 'jobcareer',
                'icon' => 'icon-home',
                'categories' => 'loops misc',
            );
			$shortcode_array['register'] = array(
                'title' => esc_html__('Register', 'jobcareer'),
                'name' => 'register',
                'icon' => 'icon-home',
                'categories' => 'loops misc',
            );
        ...
        $cs_opt_array = array(
            ...
            'field_params' => array(
                ...
                'options' => array(
                    ...
                    '1/3' => esc_html__('One third', 'jobcareer'),
                    '2/3' => esc_html__('Two third', 'jobcareer'),
                    '1/4' => esc_html__('One fourth', 'jobcareer'),
...
if (!function_exists('jobcareer_shortcode_custom_classes')) {
    ...
    function jobcareer_shortcode_custom_classes($cs_custom_class = '', $cs_custom_animation = '', $cs_custom_animation_duration = '1') {
        ...
        $custom_animation_array = array('fade' => 'Fade', 'slide' => 'Slide', 'left-slide' => 'left Slide');
        ...
        if (isset($_POST['shortcode_element']) && $_POST['shortcode_element']) {
            if ($_POST['shortcode_element'] == 'services') {
                ...
                <div class='cs-wrapp-clone cs-shortcode-wrapp'  id="cs_infobox_<?php echo intval($rand_id); ?>">
                    <header>
                        <h4>
                            <i class='icon-arrows'></i><?php esc_html_e('Service', 'jobcareer'); ?>
                        </h4>
                    ...
                    $cs_opt_array = array(
                        'name' => esc_html__('Service Title', 'jobcareer'),
                        'desc' => '',
                        'hint_text' => esc_html__('Title of the Service', 'jobcareer'),
                        'echo' => true,
                        'field_params' => array(
                            'std' => '',
                            'cust_id' => 'service_title',
                            'cust_name' => 'service_title[]',
                            'return' => true,
                            'classes' => 'txtfield',
                        ),
                    );
                    ...
                    $cs_opt_array = array(
                        'name' => esc_html__('Service View:', 'jobcareer'),
                        'desc' => '',
                        'hint_text' => esc_html__('Type of the Service', 'jobcareer'),
                        'echo' => true,
                        'field_params' => array(
                            'std' => '',
                            'cust_id' => 'service_type',
                            'cust_name' => 'service_type[]',
                            'return' => true,
                            'options' => array(
                                'size_large' => esc_html__('Large Boxed', 'jobcareer'),
                                'size_large_normal' => esc_html__('Large Normal', 'jobcareer'),
                                'size_circle' => esc_html__('Circle', 'jobcareer'),
                                'size_medium' => esc_html__('Medium', 'jobcareer'),
                                'size_small' => esc_html__('Small', 'jobcareer'),
                            ),
                            'classes' => 'dropdown',
                        ),
                    );
                    ...
                    jobcareer_fontawsome_icons_box('', $rand_id, 'cs_service_icon');
                    ...
                    $cs_opt_array = array(
                        'name' => esc_html__('Icon Postion', 'jobcareer'),
                        'desc' => '',
                        'hint_text' => '',
                        'echo' => true,
                        'field_params' => array(
                            'std' => '',
                            'cust_id' => 'service_icon_postion',
                            'cust_name' => 'service_icon_postion[]',
                            'return' => true,
                            'options' => array(
                                'left' => esc_html__('left', 'jobcareer'),
                                'right' => esc_html__('Right', 'jobcareer'),
                                'top' => esc_html__('Top', 'jobcareer'),
                    ...
                    $cs_opt_array = array(
                        ...
                        'field_params' => array(
                            'std' => '',
                            'cust_id' => 'service_icon_type',
                            'cust_name' => 'service_icon_type[]',
                            'return' => true,
                            'options' => array(
                                'circle' => esc_html__('Circle', 'jobcareer'),
                                'square' => esc_html__('Square', 'jobcareer'),
                            ),
                            'classes' => '',
                        ),
                    );
                    ...
                    $cs_opt_array = array(
                        'std' => '',
                        'id' => 'service_bg_image',
                        'name' => esc_html__('Service background Image', 'jobcareer'),
                        'desc' => '',
                        'hint_text' => '',
                        'echo' => true,
                        'array' => true,
                    ...
                    $cs_opt_array = array(
                        'name' => esc_html__('Service Link Url:', 'jobcareer'),
                        'desc' => '',
                        'hint_text' => esc_html__('Service Link Url', 'jobcareer'),
                        'echo' => true,
                        'field_params' => array(
                            'std' => '',
                            'cust_id' => 'service_link_url',
                            'cust_name' => 'service_link_url[]',
                            'return' => true,
                            'classes' => 'txtfield',
                        ),
                    );
                    ...
                    $cs_opt_array = array(
                        ...
                        'field_params' => array(
                            'std' => '',
                            'cust_id' => 'service_border',
                            'cust_name' => 'service_border[]',
                            'return' => true,
                            'options' => array(
                    ...
                    $cs_opt_array = array(
                        'name' => esc_html__('Service Text:', 'jobcareer'),
                        'desc' => '',
                        'hint_text' => '',
                        'echo' => true,
                        'field_params' => array(
                            'std' => '',
                            'cust_id' => 'service_text',
                            'cust_name' => 'service_text[]',
                            'return' => true,
                    ...
                    $cs_opt_array = array(
                        'name' => esc_html__('Divider', 'jobcareer'),
                        'desc' => '',
                        'hint_text' => '',
                        'echo' => true,
                        'field_params' => array(
                            'std' => '',
                            'cust_id' => 'service_divider',
                            'cust_name' => 'service_divider[]',
                            'return' => true,
                            'options' => array(
                                'yes' => esc_html__('Yes', 'jobcareer'),
                                'no' => esc_html__('No', 'jobcareer'),
                    ...
                    $cs_opt_array = array(
                        ...
                        'field_params' => array(
                            'std' => '',
                            'cust_id' => 'service_icon_color',
                            'cust_name' => 'service_icon_color[]',
                            'return' => true,
                            'classes' => 'bg_color',
                        ),
                    );
                    ...
                    $cs_opt_array = array(
                        ...
                        'field_params' => array(
                            'std' => '',
                            'cust_id' => 'service_icon_bg_color',
                            'cust_name' => 'service_icon_bg_color[]',
                            'return' => true,
                            'classes' => 'bg_color',
                        ),
                    );
                    ...
                    $cs_opt_array = array(
                        ...
                        'field_params' => array(
                            'std' => '',
                            'cust_id' => 'service_class',
                            'cust_name' => 'service_class[]',
                            'return' => true,
                            'classes' => 'txtfield',
                        ),
                    );
                    ...
                    $cs_opt_array = array(
                        ...
                        'field_params' => array(
                            'std' => '',
                            'cust_id' => 'service_animation',
                            'cust_name' => 'service_animation[]',
                            'return' => true,
                            'options_markup' => true,
                            'options' => $cs_anim_options,
                            'classes' => 'dropdown',
                ...
                <div class='cs-wrapp-clone cs-shortcode-wrapp'  id="cs_infobox_<?php echo intval($rand_id); ?>">
                    ...
                    $cs_opt_array = array(
                        ...
                        'desc' => '',
                        'hint_text' => esc_html__("You can set the accordian section that is open by default on frontend by select dropdown", 'jobcareer'),
                        'echo' => true,
                        'field_params' => array(
                            'std' => '',
                            'id' => '',
                    ...
                    $cs_opt_array = array(
                        ...
                        'desc' => '',
                        'hint_text' => esc_html__('Enter accordion title', 'jobcareer'),
                        'echo' => true,
                        'field_params' => array(
                            'std' => '',
                            'id' => 'accordion_title',
                    ...
                    <?php
                    $cs_opt_array = array(
                        'name' => esc_html__('Accordion Text', 'jobcareer'),
                        'desc' => '',
                        'hint_text' => esc_html__('Enter accordian content here', 'jobcareer'),
                        'echo' => true,
                        'field_params' => array(
                            'std' => '',
                            'id' => 'accordion_text',
                ...
                <div class='cs-wrapp-clone cs-shortcode-wrapp' id="cs_infobox_<?php echo intval($rand_id); ?>">
                    ...
                    <?php
                    $cs_opt_array = array(
                        'name' => esc_html__('Faq Title', 'jobcareer'),
                        'desc' => '',
                    ...
                    <?php
                    $cs_opt_array = array(
                        'name' => esc_html__('Faq Text', 'jobcareer'),
                        'desc' => '',
                        'hint_text' => esc_html__('Enter FAQ answer text here.', 'jobcareer'),
                        'echo' => true,
                        'field_params' => array(
                            'std' => '',
                            'cust_id' => '',
                ...
                <div class='cs-wrapp-clone cs-shortcode-wrapp add_tabs  cs-pbwp-content'  id="cs_infobox_<?php echo intval($rand_id); ?>">
                    ...
                    <div class="form-elements" id="<?php echo intval($rand_id); ?>">
                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                            <label><?php esc_html_e('Tab Fontawsome Icon', 'jobcareer'); ?></label>
                            <?php
                            if (function_exists('jobcareer_tooltip_text')) {
                                echo jobcareer_tooltip_text('Choose icon for this tab.it appear with title.');
                            }
                            ?>
                        </div>
                        <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                ...
                <div class='cs-wrapp-clone cs-shortcode-wrapp cs-pbwp-content'  id="cs_infobox_<?php echo intval($rand_id); ?>">
                    <header>
                        <h4><i class='icon-arrows'></i><?php esc_html_e('Multi Price Table', 'jobcareer'); ?></h4>
                        <a href='#' class='deleteit_node'><i class='icon-minus-circle'></i><?php esc_html_e('Remove', 'jobcareer'); ?></a>
                    </header>
                    <?php
                    $cs_opt_array = array(
                    ...
                    $cs_opt_array = array(
                        ...
                        'desc' => '',
                        'hint_text' => esc_html__("Price table featured optiton enable/disbale with this dropdown", 'jobcareer'),
                        'echo' => true,
                        'field_params' => array(
                            'std' => '',
                            'id' => '',
                ...
                <div class='cs-wrapp-clone cs-shortcode-wrapp cs-pbwp-content'  id="cs_infobox_<?php echo intval($rand_string); ?>">
                    <header>
                        <h4><i class='icon-arrows'></i><?php esc_html_e('Multi Counter', 'jobcareer'); ?></h4>
                        <a href='#' class='deleteit_node'><i class='icon-minus-circle'></i><?php esc_html_e('Remove', 'jobcareer'); ?></a>
                    </header>
                ...
                <?php jobcareer_fontawsome_icons_box('', $rand_string, 'counter_icon'); ?>
                        ...
                        <?php
                        $cs_opt_array = array(
                            'name' => esc_html__('Icon Size', 'jobcareer'),
                            'desc' => '',
                            'hint_text' => esc_html__("Choose icon size with this dropdown.", 'jobcareer'),
                            'echo' => true,
                            'field_params' => array(
                                'std' => '',
                                'id' => '',
                                'cust_id' => '',
                                'cust_name' => 'counter_icon_size[]',
                                'classes' => 'counter_icon_size chosen-select-no-single select-medium',
                                'options' => array(
                                    '' => esc_html__('None', 'jobcareer'),
                                    'icon-2x' => esc_html__('Small', 'jobcareer'),
                                    'icon-3x' => esc_html__('Medium', 'jobcareer'),
                                    'icon-4x' => esc_html__('Large', 'jobcareer'),
                                ),
                                'return' => true,
                            ),
                        );
                ...
                <div class='cs-wrapp-clone cs-shortcode-wrapp' id="cs_infobox_<?php echo intval($rand_id); ?>">
                    ...
                    <?php
                    $cs_opt_array = array(
                        'name' => esc_html__('List Item', 'jobcareer'),
                        'desc' => '',
                        'hint_text' => '',
                        'echo' => true,
                        'field_params' => array(
                            'std' => '',
                            'cust_id' => 'cs_list_item',
                    ...
                    <div class="form-elements" id="<?php echo intval($rand_id); ?>">
                        ...
                        <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                <?php jobcareer_fontawsome_icons_box('', $rand_id, 'cs_list_icon'); ?>
                            <p></p>
                        </div>
                    </div>
                </div>
                ...
                <div class='cs-wrapp-clone cs-shortcode-wrapp' id="cs_infobox_<?php echo intval($rand_id); ?>">
                    ...
                    <div class="form-elements" id="<?php echo intval($rand_id); ?>">
                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                            <label><?php esc_html_e('Info Box Fontawsome Icon', 'jobcareer'); ?></label>
                            <?php
                            if (function_exists('jobcareer_tooltip_text')) {
                                echo jobcareer_tooltip_text('Select the Icons you would like to show in infobox section.');
                            }
                            ?>
                        </div>
                        <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                <?php jobcareer_fontawsome_icons_box('', $rand_id, 'cs_infobox_list_icon'); ?>
                    ...
                    $cs_opt_array = array(
                        'name' => esc_html__('Icon Color', 'jobcareer'),
                        'desc' => '',
                        'hint_text' => esc_html__('Choose icon color with this picker', 'jobcareer'),
                        'echo' => true,
                        'field_params' => array(
                            'std' => '',
                            'id' => '',
                    ...
                    $cs_opt_array = array(
                        ...
                        'desc' => '',
                        'hint_text' => esc_html__('Choose  color with this picker', 'jobcareer'),
                        'echo' => true,
                        'field_params' => array(
                            'std' => '',
                            'id' => '',
                    ...
                    $cs_opt_array = array(
                        'name' => esc_html__('Short Description', 'jobcareer'),
                        'desc' => '',
                        'hint_text' => esc_html__('Enter short description of this item', 'jobcareer'),
                        'echo' => true,
                        'classes' => '',
                        'field_params' => array(
                            'std' => '',
                ...
                ?>
                <div class='cs-wrapp-clone cs-shortcode-wrapp' id="cs_infobox_<?php echo jobcareer_special_char($multiple_services_count); ?>">
                    <header>
                        <h4><i class='icon-arrows'></i><?php esc_html_e('Multiple Service', 'jobcareer'); ?></h4>
                        <a href='#' class='deleteit_node'><i class='icon-minus-circle'></i><?php esc_html_e('Remove', 'jobcareer'); ?></a>
                    </header>
                    <?php
                    $cs_opt_array = array(
                    ...
                    $cs_opt_array = array(
                        'name' => esc_html__('Background Color', 'jobcareer'),
                        'desc' => '',
                        'hint_text' => esc_html__("set background color for service.", 'jobcareer'),
                        'echo' => true,
                        'field_params' => array(
                            'std' => '',
                            'cust_id' => 'cs_text_color',
                            'classes' => 'bg_color',
                    ...
                    <div class="form-elements" id="<?php echo esc_attr($rand_id); ?>">
                        ...
                        <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                <?php jobcareer_fontawsome_icons_box('', $rand_id, 'cs_sercices_icon'); ?>
                            <p></p>
                        </div>
                    </div>
                    <?php
