...
if (!function_exists('jobcareer_pb_quotes')) {
    ...
    function jobcareer_pb_quotes($die = 0) {
        ...
        <?php jobcareer_element_setting($name, $cs_counter, $quotes_element_size, '', 'h-square', $type = ''); ?>
            <div class="cs-wrapp-class-<?php echo intval($cs_counter) ?> <?php echo esc_attr($shortcode_element); ?>" id="<?php echo esc_attr($name . $cs_counter) ?>"  
                ...
                <div class="cs-heading-area">
                    <h5><?php esc_html_e('Edit Qoute Options', 'jobcareer'); ?></h5>
        ...
        $cs_opt_array = array(
            ...
            'desc' => '',
            'hint_text' => esc_html__('Give the name of the qoute author', 'jobcareer'),
            'echo' => true,
            'field_params' => array(
        ...
        $cs_opt_array = array(
            ...
            'echo' => true,
            'field_params' => array(
                'std' => esc_url($quote_text_color),
                'id' => 'quote_text_color',
                'cust_name' => 'quote_text_color[]',
                'return' => true,
                'classes' => 'bg_color',
            ),
        );
        ...
        $cs_opt_array = array(
            ...
            'desc' => '',
            'hint_text' => esc_html__("Align the content position", 'jobcareer'),
            'classes' => 'dropdown chosen-select-no-single',
            'echo' => true,
            'field_params' => array(
                'std' => $quote_align,
                'id' => '',
                'cust_name' => 'quote_align[]',
        ...
        $cs_opt_array = array(
            'name' => esc_html__('Quote Content', 'jobcareer'),
            'desc' => '',
            'hint_text' => esc_html__('Enter section title here', 'jobcareer'),
            'echo' => true,
            'field_params' => array(
                'std' => esc_html($cs_quote_content),
                'id' => 'cs_quote_content',
