...
function jobcareer_pb_video($die = 0) {
    ...
    <div id="<?php echo esc_attr($name . $cs_counter) ?>_del" class="column  parentdelete <?php echo esc_attr($coloumn_class); ?> <?php echo esc_attr($shortcode_view); ?>" item="column" data="<?php echo jobcareer_element_size_data_array_index($video_element_size) ?>" >
        ...
        <div class="cs-wrapp-class-<?php echo intval($cs_counter) ?> <?php echo esc_attr($shortcode_element); ?>" id="<?php echo esc_attr($name . $cs_counter) ?>" data-shortcode-template="[<?php echo esc_attr(CS_SC_VIDEO); ?> {{attributes}}]{{content}}[/<?php echo esc_attr(CS_SC_VIDEO); ?>]" style="display: none;">
            <div class="cs-heading-area">
                <h5><?php esc_html_e('EDIT VIDEO OPTIONS', 'jobcareer'); ?></h5>
            ...
            <div class="cs-pbwp-content">
                <div class="cs-wrapp-clone cs-shortcode-wrapp">
                    ...
                    $cs_opt_array = array(
                        'name' => esc_html__('Width', 'jobcareer'),
                        'desc' => '',
                        'hint_text' => '',
                        'echo' => true,
                        'field_params' => array(
                            'std' => esc_html($video_width),
                            'id' => 'video_width',
                            'cust_name' => 'video_width[]',
                            'return' => true,
                        ),
                    );
