...
if (!function_exists('jobcareer_pb_map')) {
    ...
    function jobcareer_pb_map($die = 0) {
        ...
        <?php jobcareer_element_setting($name, $cs_counter, $map_element_size, '', 'globe'); ?>
            <div class="cs-wrapp-class-<?php echo esc_attr($cs_counter); ?> <?php echo esc_attr($shortcode_element); ?>" id="<?php echo esc_attr($name . $cs_counter) ?>" data-shortcode-template="[<?php echo esc_attr(CS_SC_MAP); ?> {{attributes}}]" style="display: none;">
                <div class="cs-heading-area">
                    <h5><?php esc_html_e('Edit Map Options', 'jobcareer'); ?></h5>
        ...
        ?>
                        ...
                        <?php
                        $cs_opt_array = array(
                            'name' => esc_html__('Map Height', 'jobcareer'),
                            'desc' => '',
                        ...
                        $cs_opt_array = array(
                            ...
                            'desc' => '',
                            'hint_text' => esc_html__("Set map zoom level example 100 or leave it empty by deafult will be apply.", 'jobcareer'),
                            'echo' => true,
                            'field_params' => array(
                        ...
                        <?php
                        $cs_opt_array = array(
                            'name' => esc_html__('Map Types', 'jobcareer'),
                            'desc' => '',
                            'hint_text' => esc_html__("Choose map type with this dropdown", 'jobcareer'),
                            'echo' => true,
                            'field_params' => array(
                                'std' => $map_type,
                                'id' => '',
        ...
        <?php
        $cs_opt_array = array(
            'name' => esc_html__('Info Max Width', 'jobcareer'),
            'desc' => '',
        ...
        <?php
        $cs_opt_array = array(
            'name' => esc_html__('Info Max Height', 'jobcareer'),
            'desc' => '',
            'hint_text' => esc_html__("txtfield input-small.", 'jobcareer'),
            'echo' => true,
            'field_params' => array(
        ...
        ?>
                        ...
                        $cs_opt_array = array(
                            'std' => $map_marker_icon,
                            'id' => 'map_marker_icon',
                            'name' => esc_html__('Marker Icon Path', 'jobcareer'),
                            'desc' => '',
        ...
        <?php
        $cs_opt_array = array(
            'name' => esc_html__('Disable Map Controls', 'jobcareer'),
            'desc' => '',
        ...
        ?>
                        ...
                        <?php
                        $cs_opt_array = array(
                            'name' => esc_html__('Drage able', 'jobcareer'),
                            'desc' => '',
                            'hint_text' => esc_html__("Dragable On/Off in map.", 'jobcareer'),
                            'echo' => true,
                            'field_params' => array(
                                'std' => $map_draggable,
                                'id' => '',
                        ...
                        <?php
                        $cs_opt_array = array(
                            'name' => esc_html__('Map Border', 'jobcareer'),
                            'desc' => '',
