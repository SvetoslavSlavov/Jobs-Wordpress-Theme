 ...
 *
 */
if (!function_exists('jobcareer_pb_contactus')) {

    function jobcareer_pb_contactus($die = 0) {
        ...
        ?>
        <div id="<?php echo esc_attr($name . $cs_counter) ?>_del" class="column  parentdelete <?php echo esc_attr($coloumn_class); ?> <?php echo esc_attr($shortcode_view); ?>" item="contactus" data="<?php echo jobcareer_element_size_data_array_index($contactus_element_size) ?>" >
            ...
            <div class="cs-wrapp-class-<?php echo intval($cs_counter) ?> <?php echo esc_attr($shortcode_element); ?>" id="<?php echo esc_attr($name . $cs_counter) ?>" data-shortcode-template="[<?php echo esc_attr(CS_SC_CONTACTUS); ?> {{attributes}}]" style="display: none;">
                <div class="cs-heading-area">
                    <h5><?php esc_html_e('Edit Contact Form Options', 'jobcareer'); ?></h5>
                ...
                <div class="cs-pbwp-content">
                    <div class="cs-wrapp-clone cs-shortcode-wrapp">
                        ...
                        $cs_opt_array = array(
                            ...
                            'desc' => '',
                            'hint_text' => esc_html__('Give a section title for form', 'jobcareer'),
                            'echo' => true,
                            'field_params' => array(
                                'std' => esc_html($cs_contactus_section_title),
                                'id' => 'cs_contactus_section_title',
                                'cust_name' => 'cs_contactus_section_title[]',
                                'return' => true,
                            ),
                        );
                        ...
                        $cs_opt_array = array(
                            'name' => esc_html__('Label On/Off', 'jobcareer'),
                            'desc' => '',
                            ...
                            'echo' => true,
                            'field_params' => array(
                                'std' => $cs_contactus_label,
                                'id' => '',
                                'cust_name' => 'cs_contactus_label[]',
                                'classes' => 'cs_contactus_label chosen-select-no-single select-medium',
                                'options' => array(
                        ...
                        $cs_opt_array = array(
                            ...
                            'echo' => true,
                            'field_params' => array(
                                'std' => esc_html($cs_contactus_send),
                                'id' => 'cs_contactus_send',
                                'cust_name' => 'cs_contactus_send[]',
                                'return' => true,
                            ),
                        );
    ...
    add_action('wp_ajax_jobcareer_pb_contactus', 'jobcareer_pb_contactus');
}