...
//  Start function for theme option backend setting and classes
    function jobcareer_custom_style_theme_options() {
        ...
        $cs_post_type = isset($post->ID) ? get_post_type($post->ID) : '';
        $jobcareer_page_bulider = isset($post->ID) ? get_post_meta($post->ID, "$post_type_meta", true) : '';
        ...
        $page_subheader_border_color = isset($jobcareer_page_bulider['cs_page_subheader_border_color']) ? $jobcareer_page_bulider['cs_page_subheader_border_color'] : '';
        ?>
        /*!
        * Theme Color File */
        .cs-color, 
	   ...
	   .wp-jobhunt input.acc-submit.cs-section-update{
        ...
        <?php
        if ((is_page() || is_single()) and ( $page_header_style == 'breadcrumb_header' || $page_subheader_border_color <> '')) {
            ?>
            .breadcrumb-sec .cs-search-inner {
            border-top: 1px solid <?php echo jobcareer_special_char($page_subheader_border_color); ?>;
            border-bottom: 1px solid <?php echo jobcareer_special_char($page_subheader_border_color); ?>;
            }
            <?php
        } else {
        ...
        if ((is_page() || is_single()) and ( $page_header_style == 'no-header' and $page_header_border_colr <> '')) {
            ?>
            #main-header {
            border-bottom: 1px solid <?php echo jobcareer_special_char($page_header_border_colr); ?>;
            }
            <?php
        } else {
	...
	font-style: normal;
        ...
        if (isset($cs_submenu_color) && $cs_submenu_color != '') {
            ?>
            .navigation > ul ul li > a {color:<?php echo jobcareer_special_char($cs_submenu_color); ?> !important;}
            <?php
        }
        ...
        if (isset($cs_menu_color) && $cs_menu_color != '') {
            ?>
            .navigation > ul > li > a { color:<?php echo jobcareer_special_char($cs_menu_color); ?> !important; }
            <?php
        }
        if (isset($cs_menu_active_color) && $cs_menu_active_color != '') {
            ?>
        ...
        */
        ...
        if (isset($cs_copyright_text_color) && $cs_copyright_text_color != '') {
            ?>
            footer#footer .footer-links a.footer#footer .footer-links {color:<?php echo jobcareer_special_char($cs_copyright_text_color); ?> !important;}
            <?php
        }
