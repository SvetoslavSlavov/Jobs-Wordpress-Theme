...
if (!function_exists('jobcareer_element_list')) {
    ...
    function jobcareer_element_list() {
        ...
        $element_list['element_list'] = array(
            ...
            'team' => esc_html__('Team', 'jobcareer'),
            'teams' => esc_html__('Teams', 'jobcareer'),
            ...
            'quick_slider' => esc_html__('Quick Quote', 'jobcareer'),
            'quick slider' => esc_html__('Quick Quote', 'jobcareer'),
            'quick_quote' => esc_html__('Quick Quote', 'jobcareer'),
            'quick quote' => esc_html__('Quick Quote', 'jobcareer'),
            ...
            'contactus' => esc_html__('Contact Us', 'jobcareer'),
            'tooltip' => esc_html__('Tooltip', 'jobcareer'),
            'services' => esc_html__('Services', 'jobcareer'),
            'multiple services' => esc_html__('Multiple Services', 'jobcareer'),
            ...
            'multiple_services' => esc_html__('Multiple Services', 'jobcareer'),
            'mailchimp' => esc_html__('Mail Chimp', 'jobcareer'),
            ...
            'multi_counters' => esc_html__('Multi Counter', 'jobcareer'),
            'multi counters' => esc_html__('Multi Counter', 'jobcareer'),
            'portfolio' => esc_html__('Portfolio', 'jobcareer'),
            'multi_price_table' => esc_html__('Multi Price Table', 'jobcareer'),
            'candidate' => esc_html__('Candidate', 'jobcareer'),
            'employer' => esc_html__('Employer', 'jobcareer'),
            'jobcareer' => esc_html__('Jobs', 'jobcareer'),
                                        ...
                                        <div id="<?php echo esc_attr($name . $cs_counter); ?>_del" class="column  parentdelete  <?php echo esc_attr($coloumn_class); ?> <?php echo esc_attr($shortcode_view); ?>" item="<?php echo esc_attr($jobcareer_node->getName()); ?>" data="<?php echo jobcareer_element_size_data_array_index($jobcareer_node->page_element_size) ?>" >
                                            ...
                                            <div class="cs-wrapp-class-<?php echo esc_attr($cs_counter) ?> <?php echo esc_attr($shortcode_element); ?>" id="<?php echo esc_attr($name . $cs_counter) ?>" style="display: none;">
                                                <div class="cs-heading-area">
                                                    ...
                                                    ?>
                                                    <h5>Edit  <?php echo esc_attr($shortcode_name); ?> Options</h5>
                    ...
                    <div class="cs-pbwp-content">
                        <div class="cs-wrapp-clone cs-shortcode-wrapp">
                            ...
                            ?>" >
                                     ...
                                     $cs_opt_array = array(
                                         'name' => esc_html__('Background Image Repeatition', 'jobcareer'),
                                         'desc' => '',
                                         'hint_text' => esc_html__("Choose Background Image Repeatition", 'jobcareer'),
                                         'echo' => true,
                                         'field_params' => array(
...
if (!function_exists('jobcareer_jobcareer_show_all_cats')) {
    ...
    function jobcareer_jobcareer_show_all_cats($parent, $separator, $selected = "", $taxonomy, $optional = '') {
        ...
        if ($optional) {
            $a_options = array();
            $a_options[''] = esc_html__("Please select..", 'jobcareer');
...
//  End Get all categories of post or custom posts
    ...
    if (!function_exists('jobcareer_add_social_icon')) {
        ...
        function jobcareer_add_social_icon() {
            ...
            $output .= $jobcareer_html_fields->cs_opening_field(array(
                'name' => esc_html__("Fontawesome Icon", 'jobcareer'),
                'hint_text' => '',
                    )
            );
...
if (!function_exists('jobcareer_add_banner_fields')) {
    ...
    function jobcareer_add_banner_fields() {
        ...
        echo '<td class="centr">
                    <a class="remove-btn" onclick="javascript:return confirm(\'Are you sure! You want to delete this\')" href="javascript:social_icon_del(\'' . jobcareer_slugify_text($_POST['banner_field']) . '\')"><i class="icon-cross3"></i></a>
