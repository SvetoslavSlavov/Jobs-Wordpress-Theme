                            ...
                            for ($j = 1; $j <= $a; $j++) {
                                ...
                                // Save heading page element 
                                    ...
                                    if (isset($_POST['cs_widget_element_num'][$cs_counter]) && $_POST['cs_widget_element_num'][$cs_counter] == 'shortcode') {
                                        ...
                                        if (isset($_POST['mailchimp_title'][$cs_counter_mailchimp]) && $_POST['mailchimp_title'][$cs_counter_mailchimp] != '') {
                                            $shortcode .= 'mailchimp_title="' . htmlspecialchars($_POST['mailchimp_title'][$cs_counter_mailchimp], ENT_QUOTES) . '" ';
                                        }

                                        if (isset($_POST['sub_mailchimp_title'][$cs_counter_mailchimp]) && $_POST['sub_mailchimp_title'][$cs_counter_mailchimp] != '') {
                                            $shortcode .= 'sub_mailchimp_title="' . htmlspecialchars($_POST['sub_mailchimp_title'][$cs_counter_mailchimp], ENT_QUOTES) . '" ';
                                        }

                                        if (isset($_POST['mailchimp_style'][$cs_counter_mailchimp]) && $_POST['mailchimp_style'][$cs_counter_mailchimp] != '') {
                                            $shortcode .= 'mailchimp_style="' . htmlspecialchars($_POST['mailchimp_style'][$cs_counter_mailchimp]) . '" ';
                                        }
                                        if (isset($_POST['mailchimp_size'][$cs_counter_mailchimp]) && $_POST['mailchimp_size'][$cs_counter_mailchimp] != '') {
                                            $shortcode .= 'mailchimp_size="' . htmlspecialchars($_POST['mailchimp_size'][$cs_counter_mailchimp], ENT_QUOTES) . '" ';
                                        }
                                        if (isset($_POST['mailchimp_align'][$cs_counter_mailchimp]) && $_POST['mailchimp_align'][$cs_counter_mailchimp] != '') {
                                            $shortcode .= 'mailchimp_align="' . htmlspecialchars($_POST['mailchimp_align'][$cs_counter_mailchimp], ENT_QUOTES) . '" ';
                                        }
                                        if (isset($_POST['mailchimp_font_style'][$cs_counter_mailchimp]) && $_POST['mailchimp_font_style'][$cs_counter_mailchimp] != '') {
                                            $shortcode .= 'mailchimp_font_style="' . htmlspecialchars($_POST['mailchimp_font_style'][$cs_counter_mailchimp], ENT_QUOTES) . '" ';
                                        }
                                        if (isset($_POST['mailchimp_divider'][$cs_counter_mailchimp]) && $_POST['mailchimp_divider'][$cs_counter_mailchimp] != '') {
                                            $shortcode .= 'mailchimp_divider="' . htmlspecialchars($_POST['mailchimp_divider'][$cs_counter_mailchimp]) . '" ';
                                        }
                                        if (isset($_POST['mailchimp_color'][$cs_counter_mailchimp]) && $_POST['mailchimp_color'][$cs_counter_mailchimp] != '') {
                                            $shortcode .= 'mailchimp_color="' . htmlspecialchars($_POST['mailchimp_color'][$cs_counter_mailchimp], ENT_QUOTES) . '" ';
                                        }

                                        if (isset($_POST['color_title'][$cs_counter_mailchimp]) && $_POST['color_title'][$cs_counter_mailchimp] != '') {
                                            $shortcode .= 'color_title="' . htmlspecialchars($_POST['color_title'][$cs_counter_mailchimp], ENT_QUOTES) . '" ';
                                        }
                                        if (isset($_POST['mailchimp_content_color'][$cs_counter_mailchimp]) && $_POST['mailchimp_content_color'][$cs_counter_mailchimp] != '') {
                                            $shortcode .= 'mailchimp_content_color="' . htmlspecialchars($_POST['mailchimp_content_color'][$cs_counter_mailchimp], ENT_QUOTES) . '" ';
                                        }
                                        if (isset($_POST['mailchimp_animation'][$cs_counter_mailchimp]) && $_POST['mailchimp_animation'][$cs_counter_mailchimp] != '') {
                                            $shortcode .= 'mailchimp_animation="' . htmlspecialchars($_POST['mailchimp_animation'][$cs_counter_mailchimp]) . '" ';
                                        }
                                        $shortcode .= ']';
                                        if (isset($_POST['mailchimp_content'][$cs_counter_mailchimp]) && $_POST['mailchimp_content'][$cs_counter_mailchimp] != '') {
                                            $shortcode .= htmlspecialchars($_POST['mailchimp_content'][$cs_counter_mailchimp], ENT_QUOTES);
                                        }
                                        $shortcode .= '[/' . CS_SC_MAILCHIMP . ']';
                                ...
                                // Save divider page element 
                                    ...
                                    if (isset($_POST['cs_widget_element_num'][$cs_counter]) && $_POST['cs_widget_element_num'][$cs_counter] == 'shortcode') {
                                        ...
                                        if (isset($_POST['cs_quote_content'][$cs_counter_quotes]) && $_POST['cs_quote_content'][$cs_counter_quotes] != '') {
                                            $shortcode .= 'cs_quote_content="' . htmlspecialchars($_POST['cs_quote_content'][$cs_counter_quotes]) . '" ';
                                        }
                                ...
                                // Save testimonials page element 
                                    ...
                                    if (isset($_POST['cs_widget_element_num'][$cs_counter]) && $_POST['cs_widget_element_num'][$cs_counter] == 'shortcode') {
                                        ...
                                        $section_title = '';
                                        if (isset($_POST['cs_multi_price_table_section_title'][$cs_counter_multi_price_table]) && $_POST['cs_multi_price_table_section_title'][$cs_counter_multi_price_table] != '') {
                                            $section_title = 'cs_multi_price_table_section_title="' . htmlspecialchars($_POST['cs_multi_price_table_section_title'][$cs_counter_multi_price_table], ENT_QUOTES) . '" ';
                                        }

                                        $shortcode = '[cs_multi_price_table pricetable_style="' . htmlspecialchars($_POST['pricetable_style'][$cs_counter_multi_price_table], ENT_QUOTES) . '" 
                                    ...
                                    if (isset($_POST['cs_widget_element_num'][$cs_counter]) && $_POST['cs_widget_element_num'][$cs_counter] == 'shortcode') {
                                        ...
                                        if (isset($_POST['multi_counters_num'][$cs_counter_multi_counters]) && $_POST['multi_counters_num'][$cs_counter_multi_counters] > 0) {
                                            ...
                                            for ($i = 1; $i <= $_POST['multi_counters_num'][$cs_counter_multi_counters]; $i++) {
                                                ...
                                                if (isset($_POST['counter_text_color'][$cs_counter_multi_counters_node]) && $_POST['counter_text_color'][$cs_counter_multi_counters_node] != '') {
                                                    $shortcode_item .= 'counter_text_color="' . htmlspecialchars($_POST['counter_text_color'][$cs_counter_multi_counters_node]) . '" ';
                                                }
                                                ...
                                                if (isset($_POST['counter_class'][$cs_counter_multi_counters_node]) && $_POST['counter_class'][$cs_counter_multi_counters_node] != '') {
                                                    $shortcode_item .= 'counter_class="' . htmlspecialchars($_POST['counter_class'][$cs_counter_multi_counters_node], ENT_QUOTES) . '" ';
                                                }
                                                ...
                                                $shortcode_item .= ']';
                                                if (isset($_POST['multi_counters_text'][$cs_counter_multi_counters_node]) && $_POST['multi_counters_text'][$cs_counter_multi_counters_node] != '') {
                                                    $shortcode_item .= htmlspecialchars($_POST['multi_counters_text'][$cs_counter_multi_counters_node], ENT_QUOTES);
                                                }
                                                $shortcode_item .= '[/multi_counters_item]';
                                        ...
                                        if (isset($_POST['cs_multi_counters_section_title'][$cs_counter_multi_counters]) && $_POST['cs_multi_counters_section_title'][$cs_counter_multi_counters] != '') {
                                            $section_title = 'cs_multi_counters_section_title="' . htmlspecialchars($_POST['cs_multi_counters_section_title'][$cs_counter_multi_counters], ENT_QUOTES) . '" ';
                                        }
//                                        $shortcode = '[cs_multi_counters multi_counters_style="' . isset($_POST['multi_counters_style'][$cs_counter_multi_counters]) ? htmlspecialchars($_POST['multi_counters_style'][$cs_counter_multi_counters], ENT_QUOTES) : '' . '" 
//                                                 multi_counters_text_color="' . isset($_POST['multi_counters_text_color'][$cs_counter_multi_counters]) ? htmlspecialchars($_POST['multi_counters_text_color'][$cs_counter_multi_counters]) : '' . '"
//												 multi_counters_style="' . isset($_POST['multi_counters_style'][$cs_counter_multi_counters]) ? htmlspecialchars($_POST['multi_counters_style'][$cs_counter_multi_counters]) : '' . '"
//                                                 cs_multi_counters_text_align="' . isset($_POST['cs_multi_counters_text_align'][$cs_counter_multi_counters]) ? htmlspecialchars($_POST['cs_multi_counters_text_align'][$cs_counter_multi_counters]) : '' . '"
//                                                 cs_multi_counters_class="' . isset($_POST['cs_multi_counters_class'][$cs_counter_multi_counters]) ? htmlspecialchars($_POST['cs_multi_counters_class'][$cs_counter_multi_counters], ENT_QUOTES) : '' . '"
//                                                 cs_multi_counters_animation="' . isset($_POST['cs_multi_counters_animation'][$cs_counter_multi_counters]) ? htmlspecialchars($_POST['cs_multi_counters_animation'][$cs_counter_multi_counters]) : '' . '"
//                                                 ' . $section_title . ' ]' . $shortcode_item . '[/cs_multi_counters]';
                                        $multi_counters_style = isset($_POST['multi_counters_style'][$cs_counter_multi_counters]) ? htmlspecialchars($_POST['multi_counters_style'][$cs_counter_multi_counters], ENT_QUOTES) : '';
                                        $multi_counters_text_color = isset($_POST['multi_counters_text_color'][$cs_counter_multi_counters]) ? htmlspecialchars($_POST['multi_counters_text_color'][$cs_counter_multi_counters]) : '';
                                        //isset($_POST['multi_counters_style'][$cs_counter_multi_counters]) ? htmlspecialchars($_POST['multi_counters_style'][$cs_counter_multi_counters]) : '';
                                        $cs_multi_counters_text_align = isset($_POST['cs_multi_counters_text_align'][$cs_counter_multi_counters]) ? htmlspecialchars($_POST['cs_multi_counters_text_align'][$cs_counter_multi_counters]) : '';
                                        $cs_multi_counters_class = isset($_POST['cs_multi_counters_class'][$cs_counter_multi_counters]) ? htmlspecialchars($_POST['cs_multi_counters_class'][$cs_counter_multi_counters], ENT_QUOTES) : '';
                                        $cs_multi_counters_animation = isset($_POST['cs_multi_counters_animation'][$cs_counter_multi_counters]) ? htmlspecialchars($_POST['cs_multi_counters_animation'][$cs_counter_multi_counters]) : '';


                                        $shortcode = '[cs_multi_counters multi_counters_style="' . $multi_counters_style . '" ';
                                        if (isset($multi_counters_text_color) && $multi_counters_text_color != '') {
                                            $shortcode.=' multi_counters_text_color="' . $multi_counters_text_color . '"';
                                        }
                                        if (isset($multi_counters_style) && $multi_counters_style != '') {
                                            $shortcode.='multi_counters_style="' . $multi_counters_style . '"';
                                        }
                                        if (isset($cs_multi_counters_text_align) && $cs_multi_counters_text_align != '') {
                                            $shortcode.='cs_multi_counters_text_align="' . $cs_multi_counters_text_align . '"';
                                        }
                                        if (isset($cs_multi_counters_class) && $cs_multi_counters_class != '') {
                                            $shortcode.=' cs_multi_counters_class="' . $cs_multi_counters_class . '"';
                                        }

                                        $shortcode.='cs_multi_counters_animation="' . $cs_multi_counters_animation . '"
                                                 ' . $section_title . ' ]' . $shortcode_item . '[/cs_multi_counters]';
                                ...
                                // Save List page element 
                                    ...
                                    if (isset($_POST['cs_widget_element_num'][$cs_counter]) && $_POST['cs_widget_element_num'][$cs_counter] == 'shortcode') {
                                        ...
                                        if (isset($_POST['cs_service_icon'][$cs_counter_services]) && $_POST['cs_service_icon'][$cs_counter_services] != '') {
                                            $shortcode_item .= 'cs_service_icon="' . htmlspecialchars($_POST['cs_service_icon'][$cs_counter_services], ENT_QUOTES) . '" ';
                                        }
                                        if (isset($_POST['cs_service_icon_color'][$cs_counter_services]) && $_POST['cs_service_icon_color'][$cs_counter_services] != '') {
                                            $shortcode_item .= 'cs_service_icon_color="' . htmlspecialchars($_POST['cs_service_icon_color'][$cs_counter_services], ENT_QUOTES) . '" ';
                                        }
                                        if (isset($_POST['cs_service_link'][$cs_counter_services]) && $_POST['cs_service_link'][$cs_counter_services] != '') {
                                            $shortcode_item .= 'cs_service_link="' . htmlspecialchars($_POST['cs_service_link'][$cs_counter_services], ENT_QUOTES) . '" ';
                                        }
                                        ...
                                        if (isset($_POST['cs_service_content'][$cs_counter_services]) && $_POST['cs_service_content'][$cs_counter_services] != '') {
                                            $shortcode_item .= 'cs_service_content="' . htmlspecialchars($_POST['cs_service_content'][$cs_counter_services], ENT_QUOTES) . '" ';
                                        }
                                        ...
                                        if (isset($_POST['cs_service_view'][$cs_counter_services]) && $_POST['cs_service_view'][$cs_counter_services] != '') {
                                            $shortcode_item .= 'cs_service_view="' . htmlspecialchars($_POST['cs_service_view'][$cs_counter_services], ENT_QUOTES) . '" ';
                                        }
...
//                                        }
//                                        if (isset($_POST['cs_button_color'][$cs_counter_services]) && $_POST['cs_button_color'][$cs_counter_services] != '') {
//                                            $shortcode_item .= 'cs_button_color="' . htmlspecialchars($_POST['cs_button_color'][$cs_counter_services]) . '" ';
//                                        }
//
//                                        if (isset($_POST['cs_button_text'][$cs_counter_services]) && $_POST['cs_button_text'][$cs_counter_services] != '') {
//                                            $shortcode_item .= 'cs_button_text="' . htmlspecialchars($_POST['cs_button_text'][$cs_counter_services]) . '" ';
//                                        }
//                                        if (isset($_POST['cs_button_link'][$cs_counter_services]) && $_POST['cs_button_link'][$cs_counter_services] != '') {
//                                            $shortcode_item .= 'cs_button_link="' . htmlspecialchars($_POST['cs_button_link'][$cs_counter_services]) . '" ';
//                                        }
...
//                                        }
//
//                                        if (isset($_POST['cs_service_content_align'][$cs_counter_services]) && $_POST['cs_service_content_align'][$cs_counter_services] != '') {
//                                            $shortcode_item .= 'cs_service_content_align="' . htmlspecialchars($_POST['cs_service_content_align'][$cs_counter_services]) . '" ';
//                                        }
//                                        if (isset($_POST['cs_button_text_color'][$cs_counter_services]) && $_POST['cs_button_text_color'][$cs_counter_services] != '') {
//                                            $shortcode_item .= 'cs_button_text_color="' . htmlspecialchars($_POST['cs_button_text_color'][$cs_counter_services]) . '" ';
//                                        }
//
//
//                                        if (isset($_POST['cs_service_styles'][$cs_counter_services]) && $_POST['cs_service_styles'][$cs_counter_services] != '') {
//                                            $shortcode_item .= 'cs_service_styles="' . htmlspecialchars($_POST['cs_service_styles'][$cs_counter_services]) . '" ';
//                                        }
//
//                                        if (isset($_POST['cs_service_image_align'][$cs_counter_services]) && $_POST['cs_service_image_align'][$cs_counter_services] != '') {
//                                            $shortcode_item .= 'cs_service_image_align="' . htmlspecialchars($_POST['cs_service_image_align'][$cs_counter_services]) . '" ';
//                                        }
//
//                                        if (isset($_POST['cs_service_image_size'][$cs_counter_services]) && $_POST['cs_service_image_size'][$cs_counter_services] != '') {
//                                            $shortcode_item .= 'cs_service_image_size="' . htmlspecialchars($_POST['cs_service_image_size'][$cs_counter_services]) . '" ';
//                                        }
//
//                                        if (isset($_POST['cs_service_image_icon'][$cs_counter_services]) && $_POST['cs_service_image_icon'][$cs_counter_services] != '') {
//                                            $shortcode_item .= 'cs_service_image_icon="' . htmlspecialchars($_POST['cs_service_image_icon'][$cs_counter_services]) . '" ';
//                                        }
//                                        if (isset($_POST['cs_service_image_circle'][$cs_counter_services]) && $_POST['cs_service_image_circle'][$cs_counter_services] != '') {
//                                            $shortcode_item .= 'cs_service_image_circle="' . htmlspecialchars($_POST['cs_service_image_circle'][$cs_counter_services]) . '" ';
//                                        }
//
//                                        if (isset($_POST['cs_service_icon_circle'][$cs_counter_services]) && $_POST['cs_service_icon_circle'][$cs_counter_services] != '') {
//                                            $shortcode_item .= 'cs_service_icon_circle="' . htmlspecialchars($_POST['cs_service_icon_circle'][$cs_counter_services]) . '" ';
//                                        }
//                                        if (isset($_POST['cs_service_background_color'][$cs_counter_services]) && $_POST['cs_service_background_color'][$cs_counter_services] != '') {
//                                            $shortcode_item .= 'cs_service_background_color="' . htmlspecialchars($_POST['cs_service_background_color'][$cs_counter_services]) . '" ';
//                                        }
//
...
//                                        }
//
//                                        if (isset($_POST['cs_service_icon_background_color'][$cs_counter_services]) && $_POST['cs_service_icon_background_color'][$cs_counter_services] != '') {
//                                            $shortcode_item .= 'cs_service_icon_background_color="' . htmlspecialchars($_POST['cs_service_icon_background_color'][$cs_counter_services]) . '" ';
//                                        }
//
...
//                                        }
//
//                                        if (isset($_POST['cs_sercices_icon'][$cs_counter_services]) && $_POST['cs_sercices_icon'][$cs_counter_services] != '') {
//                                            $shortcode_item .= 'cs_sercices_icon="' . htmlspecialchars($_POST['cs_sercices_icon'][$cs_counter_services]) . '" ';
//                                        }
//
...
//                                        }
                                    ...
                                    if (isset($_POST['cs_widget_element_num'][$cs_counter]) && $_POST['cs_widget_element_num'][$cs_counter] == 'shortcode') {
                                        ...
                                        if (isset($_POST['info_list_num'][$cs_counter_infobox]) && $_POST['info_list_num'][$cs_counter_infobox] > 0) {
                                            for ($i = 1; $i <= $_POST['info_list_num'][$cs_counter_infobox]; $i++) {
                                                ...
                                                if (isset($_POST['cs_infobox_list_text_color'][$cs_counter_infobox_node]) && $_POST['cs_infobox_list_text_color'][$cs_counter_infobox_node] != '') {
                                                    $shortcode_item .= 'cs_infobox_list_text_color="' . htmlspecialchars($_POST['cs_infobox_list_text_color'][$cs_counter_infobox_node], ENT_QUOTES) . '" ';
                                                }
                                                $shortcode_item .= ']';
                                ...
                                // Multiple services
                                else if (isset($_POST['cs_orderby'][$cs_counter]) && $_POST['cs_orderby'][$cs_counter] == "multiple_services") {
                                    ...
                                    if (isset($_POST['cs_widget_element_num'][$cs_counter]) && $_POST['cs_widget_element_num'][$cs_counter] == 'shortcode') {
                                        ...
                                        if (isset($_POST['multiple_services_num'][$cs_counter_multiple_services]) && $_POST['multiple_services_num'][$cs_counter_multiple_services] > 0) {
                                            for ($i = 1; $i <= $_POST['multiple_services_num'][$cs_counter_multiple_services]; $i++) {
                                                ...
                                                if (isset($_POST['cs_service_image_icon'][$cs_counter_multiple_services_node]) && $_POST['cs_service_image_icon'][$cs_counter_multiple_services_node] != '') {
                                                    $shortcode_item .='cs_service_image_icon="' . htmlspecialchars($_POST['cs_service_image_icon'][$cs_counter_multiple_services_node]) . '" ';
                                                }
                                                if (isset($_POST['cs_service_image_circle'][$cs_counter_multiple_services_node]) && $_POST['cs_service_image_circle'][$cs_counter_multiple_services_node] != '') {
                                                    $shortcode_item .='cs_service_image_circle="' . htmlspecialchars($_POST['cs_service_image_circle'][$cs_counter_multiple_services_node]) . '" ';
                                                }

                                                if (isset($_POST['cs_sercices_icon'][$cs_counter_multiple_services_node]) && $_POST['cs_sercices_icon'][$cs_counter_multiple_services_node] != '') {
                                                    $shortcode_item .='cs_sercices_icon="' . htmlspecialchars($_POST['cs_sercices_icon'][$cs_counter_multiple_services_node]) . '" ';
                                                }
                                                if (isset($_POST['cs_service_icon_size'][$cs_counter_multiple_services_node]) && $_POST['cs_service_icon_size'][$cs_counter_multiple_services_node] != '') {
                                                    $shortcode_item .='cs_service_icon_size="' . htmlspecialchars($_POST['cs_service_icon_size'][$cs_counter_multiple_services_node]) . '" ';
                                                }

                                                if (isset($_POST['cs_service_icon_color'][$cs_counter_multiple_services_node]) && $_POST['cs_service_icon_color'][$cs_counter_multiple_services_node] != '') {
                                                    $shortcode_item .='cs_service_icon_color="' . htmlspecialchars($_POST['cs_service_icon_color'][$cs_counter_multiple_services_node]) . '" ';
                                                }
                                                if (isset($_POST['cs_service_content_color'][$cs_counter_multiple_services_node]) && $_POST['cs_service_content_color'][$cs_counter_multiple_services_node] != '') {
                                                    $shortcode_item .='cs_service_content_color="' . htmlspecialchars($_POST['cs_service_content_color'][$cs_counter_multiple_services_node]) . '" ';
                                                }
                                                if (isset($_POST['cs_service_background_color'][$cs_counter_multiple_services_node]) && $_POST['cs_service_background_color'][$cs_counter_multiple_services_node] != '') {
                                                    $shortcode_item .='cs_service_background_color="' . htmlspecialchars($_POST['cs_service_background_color'][$cs_counter_multiple_services_node]) . '" ';
                                                }
                                                if (isset($_POST['cs_service_image_size'][$cs_counter_multiple_services_node]) && $_POST['cs_service_image_size'][$cs_counter_multiple_services_node] != '') {
                                                    $shortcode_item .='cs_service_image_size="' . htmlspecialchars($_POST['cs_service_image_size'][$cs_counter_multiple_services_node]) . '" ';
                                                }

                                                if (isset($_POST['cs_service_icon_circle'][$cs_counter_multiple_services_node]) && $_POST['cs_service_icon_circle'][$cs_counter_multiple_services_node] != '') {
                                                    $shortcode_item .='cs_service_icon_circle="' . htmlspecialchars($_POST['cs_service_icon_circle'][$cs_counter_multiple_services_node]) . '" ';
                                                }
                                                if (isset($_POST['cs_button_link'][$cs_counter_multiple_services_node]) && $_POST['cs_button_link'][$cs_counter_multiple_services_node] != '') {
                                                    $shortcode_item .='cs_button_link="' . htmlspecialchars($_POST['cs_button_link'][$cs_counter_multiple_services_node]) . '" ';
                                                }
                                                if (isset($_POST['cs_button_text'][$cs_counter_multiple_services_node]) && $_POST['cs_button_text'][$cs_counter_multiple_services_node] != '') {
                                                    $shortcode_item .='cs_button_text="' . htmlspecialchars($_POST['cs_button_text'][$cs_counter_multiple_services_node]) . '" ';
                                                }

                                                if (isset($_POST['cs_button_text_color'][$cs_counter_multiple_services_node]) && $_POST['cs_button_text_color'][$cs_counter_multiple_services_node] != '') {
                                                    $shortcode_item .='cs_button_text_color="' . htmlspecialchars($_POST['cs_button_text_color'][$cs_counter_multiple_services_node]) . '" ';
                                                }
                                                if (isset($_POST['cs_website_url'][$cs_counter_multiple_services_node]) && $_POST['cs_button_color'][$cs_counter_multiple_services_node] != '') {
                                                    $shortcode_item .='cs_button_color="' . htmlspecialchars($_POST['cs_button_color'][$cs_counter_multiple_services_node]) . '" ';
                                                }
                                        ...
                                        if (isset($_POST['cs_service_content_align'][$cs_counter_multiple_services]) && $_POST['cs_service_content_align'][$cs_counter_multiple_services] != '') {
                                            $shortcode .='cs_service_content_align="' . htmlspecialchars($_POST['cs_service_content_align'][$cs_counter_multiple_services]) . '" ';
                                        }

                                        if (isset($_POST['cs_service_image_align'][$cs_counter_multiple_services]) && $_POST['cs_service_image_align'][$cs_counter_multiple_services] != '') {
                                            $shortcode .='cs_service_image_align="' . htmlspecialchars($_POST['cs_service_image_align'][$cs_counter_multiple_services]) . '" ';
                                        }
                                        if (isset($_POST['cs_service_styles'][$cs_counter_multiple_services]) && $_POST['cs_service_styles'][$cs_counter_multiple_services] != '') {
                                            $shortcode .='cs_service_styles="' . htmlspecialchars($_POST['cs_service_styles'][$cs_counter_multiple_services]) . '" ';
                                        }
                                    ...
                                    if (isset($_POST['cs_widget_element_num'][$cs_counter]) && $_POST['cs_widget_element_num'][$cs_counter] == 'shortcode') {
                                        ...
                                        if (isset($_POST['cs_employer_searchbox_title_top'][$cs_counter_employer]) && $_POST['cs_employer_searchbox_title_top'][$cs_counter_employer] != '') {
                                            $shortcode .= 'cs_employer_searchbox_title_top="' . htmlspecialchars($_POST['cs_employer_searchbox_title_top'][$cs_counter_employer], ENT_QUOTES) . '" ';
                                        }
                                ...
                                } else if (isset($_POST['cs_orderby'][$cs_counter]) && $_POST['cs_orderby'][$cs_counter] == 'jobcareer') {
                                    $shortcode = '';
                                    $job = $column->addChild('jobcareer');
                                    ...
                                    if (isset($_POST['cs_widget_element_num'][$cs_counter]) && $_POST['cs_widget_element_num'][$cs_counter] == 'shortcode') {
                                        $shortcode_str = stripslashes($_POST['shortcode']['jobcareer'][$cs_shortcode_counter_job]);
