...
jQuery(document).ready(function ($) {
    ...
    var Data = [{
            "Class": "column_100", "title": "100", "element": ["gallery", "slider", "blog", "team", "column", "accordions","quotes", "client", "contact", "divider", "message_box", 'image', "image_frame", "map", "video", "slider", "dropcap", "pricetable", "tabs", "accordion", "prayer", "table", "flex_column", "clients", "spacer", "heading", "testimonials", "infobox", "promobox", "offerslider", "audio", "icons", "contactus", "tooltip", "services", "highlight", "list", "mesage", "faq", "counter", "members", "multiple_services", "mailchimp", "events", "team_post", "portfolio", "quick_slider", "subscriber", "multi_counters", "call_to_action", "time_line", "job_package", "button", "multi_price_table", "flex_editor", "tweets", "teams","sitemap"]},
        {"Class": "column_75", "title": "75", "element": ["gallery", "slider", "blog", "team", "column", "accordions", "team","quotes", "client", "contact", "column", "divider", "message_box", "image_frame", 'image', "map", "video", "slider", "dropcap", "pricetable", "tabs", "accordion", "advance_search", "prayer", "table", "flex_column", "clients", "spacer", "heading", "testimonials", "infobox", "promobox", "offerslider", "audio", "icons", "contactus", "tooltip", "highlight", "list", "mesage", "faq", "services", "counter", "members", "directory_map", "multiple_services", "mailchimp", "events", "team_post", "portfolio", "quick_slider", "subscriber", "multi_counters", "call_to_action", "time_line", "job_package", "button", "multi_price_table", "flex_editor", "tweets", "teams","sitemap"]},
        {"Class": "column_67", "title": "67", "element": ["gallery", "slider", "blog", "team", "column", "accordions", "team", "client", "quotes","contact", "divider", "message_box", 'image', "image_frame", "map", "video", "slider", "dropcap", "pricetable", "tabs", "accordion", "advance_search", "prayer", "pointtable", "table", "flex_column", "clients", "spacer", "heading", "testimonials", "testimonials", "infobox", "promobox", "offerslider", "audio", "icons", "contactus", "tooltip", "highlight", "services", "list", "mesage", "faq", "counter", "members", "multiple_services", "mailchimp", "events", "team_post", "portfolio", "quick_slider", "subscriber", "multi_counters", "call_to_action", "time_line", "job_package", "button", "multi_price_table", "flex_editor", "tweets", "teams","sitemap"]},
        {"Class": "column_50", "title": "50", "element": ["gallery", "slider", "blog", "team", "column", "services", "accordions","quotes", "team", "client", "contact", "column", "divider", "message_box", "image_frame", 'image', "map", "video", "slider", "dropcap", "pricetable", "services", "tabs", "accordion", "advance_search", "prayer", "table", "flex_column", "clients", "spacer", "heading", "testimonials", "infobox", "promobox", "offerslider", "audio", "icons", "contactus", "tooltip", "highlight", "list", "mesage", "faq", "counter", "members", "multiple_services", "mailchimp", "events", "team_post", "portfolio", "quick_slider", "subscriber", "multi_counters", "call_to_action", "time_line", "job_package", "button", "multi_price_table", "flex_editor", "tweets", "teams","sitemap"]},
        {"Class": "column_33", "title": "33", "element": ["slider", "blog", "events", "team", "column", "accordions", "message_box","quotes", 'image', "fixtures", "map", "video", "slider", "dropcap", "pricetable", "services", "tabs", "accordion", "prayer", "pointtable", "flex_column", "spacer", "heading", "testimonials", "infobox", "promobox", "audio", "icons", "contactus", "tooltip", "highlight", "list", "mesage", "faq", "counter", "multiple_services", "mailchimp", "events", "team_post", "portfolio", "quick_slider", "subscriber", "multi_counters", "call_to_action", "time_line", "job_package", "button", "multi_price_table", "flex_editor", "tweets", "teams","sitemap"]},
        {"Class": "column_25", "title": "25", "element": ["column", "divider", "message_box", "image_frame", "map", "video", "slider","quotes", "dropcap", "pricetable", "services", "pastor", 'services', 'counter', "flex_column", "spacer", "heading", "testimonials", "infobox", "promobox", "audio", "icons", "contactus", "tooltip", "highlight", "list", "mesage", "faq", "counter", "multiple_services", "mailchimp", "events", "team_post", "portfolio", "quick_slider", "subscriber", "multi_counters", "call_to_action", "time_line", "job_package", "button", "multi_price_table", "flex_editor", "tweets", "teams","sitemap"]}, ];
...
/*
 *  show clider function 
 */
function cs_show_slider(value) {
    "use strict";
	if (value == 'slider') {
        jQuery('#cs_no_header_fields').hide();
		jQuery('#cs_rev_slider_fields').show();
		jQuery('#jobcareer_breadcrumbs_fields').hide();
	} else if (value == 'no_header') {
		jQuery('#cs_no_header_fields').show();
		jQuery('#cs_rev_slider_fields').hide();
		jQuery('#jobcareer_breadcrumbs_fields').hide();
    } else {
        jQuery('#cs_no_header_fields').hide();
		jQuery('#cs_rev_slider_fields').hide();
		jQuery('#jobcareer_breadcrumbs_fields').show();
    }
}

/*
 *  End show clider function 
 */
