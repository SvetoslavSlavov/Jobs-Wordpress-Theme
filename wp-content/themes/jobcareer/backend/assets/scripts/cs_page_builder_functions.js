...
var Data = [
    {"Class": "column_100", "title": "100", "element": ["gallery", "slider", "blog", "column", "accordions", "team", "client", "contact", "column", "divider", "message_box", 'image', "image_frame", "map", "video", "slider", "dropcap", "pricetable", "tabs", "accordion", "prayer", "advance_search", "parallax", "table", "call_to_action", "flex_column", "clients", "spacer", "heading", "testimonials", "services", "infobox", "promobox", "offerslider", "audio", "icons", "contactus", "tooltip", "highlight", "list", "mesage", "faq", "members", "directory_categories", "directory_map", "multiple_services", "quotes", "mailchimp", "facilities", "events", "team_post", "portfolio", "quick_slider", "multi_counters", "flex_editor", "cv_package", "multi_price_table", "candidate", "employer", "jobs", "job_specialisms", "candidate", "tweets", "button", "progressbars", "sitemap"]},
    {"Class": "column_75", "title": "75", "element": ["gallery", "slider", "blog", "column", "accordions", "team", "client", "quotes", "contact", "column", "divider", "message_box", 'image', "image_frame", "map", "video", "slider", "dropcap", "pricetable", "tabs", "accordion", "advance_search", "prayer", "table", "flex_column", "clients", "spacer", "heading", "testimonials", "infobox", "promobox", "offerslider", "audio", "icons", "contactus", "tooltip", "services", "highlight", "list", "mesage", "faq", "members", "multiple_services", "mailchimp", "facilities", "events", "team_post", "portfolio", "quick_slider", "multi_counters", "flex_editor", "cv_package", "multi_price_table", "candidate", "employer", "jobs", "job_specialisms", "candidate", "tweets", "button", "call_to_action", "progressbars", "sitemap"]},
    {"Class": "column_67", "title": "67", "element": ["gallery", "slider", "blog", "column", "accordions", "team", "client", "quotes", "contact", "column", "divider", "message_box", 'image', "image_frame", "map", "video", "slider", "dropcap", "pricetable", "tabs", "accordion", "advance_search", "prayer", "pointtable", "table", "flex_column", "clients", "spacer", "heading", "testimonials", "infobox", "promobox", "offerslider", "audio", "icons", "contactus", "tooltip", "highlight", "list", "services", "mesage", "faq", "members", "multiple_services", "mailchimp", "facilities", "events", "team_post", "portfolio", "quick_slider", "multi_counters", "flex_editor", "multi_price_table", "candidate", "employer", "jobs", "job_specialisms", "candidate", "tweets", "button", "call_to_action", "progressbars", "sitemap"]},
    {"Class": "column_50", "title": "50", "element": ["gallery", "slider", "blog", "column", "accordions", "team", "client", "quotes", "contact", "column", "divider", "message_box", 'image', "image_frame", "map", "video", "slider", "dropcap", "pricetable", "tabs", "accordion", "advance_search", "prayer", "teams", "services", "table", "flex_column", "clients", "spacer", "heading", "testimonials", "infobox", "promobox", "offerslider", "audio", "icons", "contactus", "tooltip", "highlight", "list", "mesage", "faq", "counter", "members", "multiple_services", "mailchimp", "facilities", "events", "team_post", "portfolio", "quick_slider", "multi_counters", "flex_editor", "multi_price_table", "candidate", "employer", "jobs", "job_specialisms", "candidate", "tweets", "button", "call_to_action", "progressbars", "sitemap"]},
    {"Class": "column_33", "title": "33", "element": ["slider", "blog", "event", "column", "accordions", "message_box", 'image', "quotes", "fixtures", "map", "video", "slider", "dropcap", "services", "tabs", "accordion", "prayer", "pointtable", "teams", "flex_column", "pricetable", "spacer", "heading", "testimonials", "infobox", "promobox", "audio", "icons", "contactus", "tooltip", "highlight", "list", "mesage", "faq", "directory_map", "multiple_services", "mailchimp", "facilities", "events", "table", "team_post", "portfolio", "quick_slider", "multi_counters", "flex_editor", "candidate", "employer", "jobs", "job_specialisms", "candidate", "tweets", "button", "call_to_action", "progressbars", "sitemap"]},
    {"Class": "column_25", "title": "25", "element": ["gallery", "column", "divider", "message_box", 'image', "image_frame", "quotes", "map", "video", "slider", "dropcap", "pricetable", "pastor", "services", "counter", "teams", 'services', "flex_column", "spacer", "heading", "testimonials", "infobox", "promobox", "audio", "icons", "contactus", "tooltip", "highlight", "list", "mesage", "faq", "multiple_services", "mailchimp", "facilities", "events", "team_post", "portfolio", "quick_slider", "multi_counters", "flex_editor", "multi_price_table", "candidate", "employer", "jobs", "job_specialisms", "candidate", "tweets", "button", "call_to_action", "progressbars", "sitemap"]},
];
 ...
 */
var DataElement = [{"ClassName": "col_width_full", "element": ["gallery", "slider", "blog", "spacer", "event", "contact", "parallax", "services"]}];
 ...
 */
function jobcareer_shortcode_element_ajax_call(val, id, admin_url) {
    "use strict";
   
    if (val != "") {
        var shortcode_counter = 1
        var action = val;
        var newCustomerForm = "shortcode_element=" + val + '&action=jobcareer_shortcode_element_ajax_call';
        jQuery.ajax({
            type: "POST",
            url: admin_url,
            data: newCustomerForm,
