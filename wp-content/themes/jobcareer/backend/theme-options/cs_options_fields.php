            ...
            foreach ($jobcareer_sett_options as $value) {
                ...
                switch ($value['type']) {
                    ...
                    case 'slider code':
                        ...
                        $show = '';
                        if ($jobcareer_options['cs_default_header'] == 'slider') {
                            $show = 'block';
                        } else if ($jobcareer_options['cs_default_header'] == 'breadcrumbs_sub_header' || $jobcareer_options['cs_default_header'] == 'no_header') {
                            $show = 'none';
                        }
                        $rev_options = '';
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">';
                    ...
                    case 'default header':
                        ...
                        $cs_opt_array = array(
                            ...
                            'field_params' => array(
                                ...
                                'cust_id' => isset($value['id']) ? $value['id'] : '',
                                'cust_name' => isset($value['id']) ? $value['id'] : '',
                                'extra_atr' => ' onchange="cs_show_slider(this.value)"',
                                'options' => isset($value['options']) ? $value['options'] : '',
                                'classes' => $cs_classes,
                                'return' => true,
                            ),
					...
					<div class="sidebar-area" style="display:' . $display . '">
                        ...
                        if ($display == 'block') {
                            ...
                            foreach ($val['sidebar'] as $sidebar) {
                                ...
                                $output.= $sidebar
                                        . '</td>
											<td class="centr"> <a class="remove-btn" onclick="javascript:return confirm(\''.esc_html__('Are you sure! You want to delete this','jobcareer').'\')" href="javascript:cs_div_remove(\'sidebar_' . $i . '\')" data-toggle="tooltip" data-placement="top" title="Remove"><i class="icon-times"></i></a>
										</td>
									</tr>';
                                $i++;
                            }
                    ...
                    case "footer_sidebar":
                        ...
                        $output .= $jobcareer_form_fields->cs_form_select_render(array(
                            ...
                            'options' =>
                            array(
                                '2 Column (16.67%)' => esc_html__('2 Column (16.67%)', 'jobcareer'),
                                '3 Column (25%)' => esc_html__('3 Column (25%)', 'jobcareer'),
                                '4 Column (33.33%)' => esc_html__('4 Column (33.33%)', 'jobcareer'),
                                '6 Column (50%)' => esc_html__('6 Column (50%)', 'jobcareer'),
                                '8 Column (66.66%)' => esc_html__('8 Column (66.66%)', 'jobcareer'),
                                '9 Column (75%)' => esc_html__('9 Column (75%)', 'jobcareer'),
                                '10 Column (83.33%)' => esc_html__('10 Column (83.33%)', 'jobcareer'),
                                '12 Column (100%)' => esc_html__('12 Column (100%)', 'jobcareer'),
                            ),
                            'return' => true,
                        ));
                        ...
                        if ($network_list <> '') {
                            foreach ($network_list as $network) {
                                if (isset($network_list[$i]) || isset($network_list[$i])) {
                                    ...
                                    $output .= $jobcareer_html_fields->cs_opening_field(array(
                                        'name' => esc_html__("Fontawsome Color", 'jobcareer'),
                                        'hint_text' => '',
                                            )
                                    );
