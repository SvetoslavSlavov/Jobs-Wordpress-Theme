...
if (!function_exists('jobcareer_theme_option')) {
 ...
 if (isset($jobcareer_options) and isset($jobcareer_options['footer_sidebar'])) {
        ...
        $jobcareer_sett_options[] = array(
            ...
            "type" => "horizontal_tab",
            "std" => "",
            "options" => array('Background color' => 'background_tab_color', 'Background' => 'background_tab', 'Pattern' => 'pattern_tab', 'Custom Image' => 'custom_image_tab')
        );
        ...
        $jobcareer_sett_options[] = array("name" => esc_html__("RTL", 'jobcareer'),
            "desc" => "",
            "hint_text" => esc_html__("Switch of RTL(Right to Left) On/Off  for languages like Arabic,Persian  etc.", 'jobcareer'),
            "id" => "cs_style_rtl",
            "std" => "off",
            "type" => "checkbox",
            "main_id" => 'cs_style_rtl_main',
        ...
        if (class_exists('wp_jobhunt')) {
            ...
            $jobcareer_sett_options[] = array("name" => esc_html__("Select Language", 'jobcareer'),
                "desc" => "",
                "hint_text" => "Dropdown for select translated language file .mo format generated by plugin. Example Loco Translate & WPML etc..",
                "id" => "cs_language_file",
                "std" => "30",
                "type" => "select",
                'classes' => 'chosen-select-no-single',
                "options" => isset($cs_plugin_language) ? $cs_plugin_language : '',
            );
        }
        ...
        $jobcareer_sett_options[] = array(
            "name" => esc_html__("Select Header", 'jobcareer'),
            "desc" => "",
            ...
            'classes' => 'chosen-select-no-single',
            "type" => "select_values",
            "options" => array('default-header' => esc_html__("Default Header", 'jobcareer'), 'dark-header' => esc_html__("Dark Header", 'jobcareer')),
        );
        ...
        $jobcareer_sett_options[] = array("name" => esc_html__("Default", 'jobcareer'),
            "desc" => "",
            "hint_text" => esc_html__("Subheader settings made here will be implemented on all default subheaders pages.", 'jobcareer'),
        ...
        $jobcareer_sett_options[] = array("name" => esc_html__("Revolution Slider", 'jobcareer'),
            "desc" => "",
            "hint_text" => esc_html__("For apply revolutoion  slider on all default subheader pages.", 'jobcareer'),
            "id" => "cs_custom_slider",
            "std" => "",
            "type" => "slider code",
            "options" => '',
        ...
        $jobcareer_sett_options[] = array(
            ...
            "desc" => "",
            "hint_text" => "Breadcrumbs enable/disable from subheader.",
        ...
        $jobcareer_sett_options[] = array("name" => esc_html__("Background Color", 'jobcareer'),
            "desc" => "",
            "hint_text" => "Provide a hex color code here (with #) for subheader background.",
        ...
        $jobcareer_sett_options[] = array("name" => esc_html__("Text Color", 'jobcareer'),
            "desc" => "",
            "hint_text" => "Provide a hex color code here (with #) for subheader text.",
        ...
        $jobcareer_sett_options[] = array("name" => esc_html__("Overlay Color", 'jobcareer'),
            "desc" => "",
            "hint_text" => "Provide a hex color code here (with #) for Overlay text.",
        ...
        $jobcareer_sett_options[] = array(
            ...
            "desc" => "",
            "hint_text" => "Set the Opacity of Overlay.",
        ...
        $jobcareer_sett_options[] = array("name" => esc_html__("Parallax", 'jobcareer'),
            "desc" => "",
            "hint_text" => "Parallax is an effect where the background content or image in this case, is moved at a different speed than the foreground content while scrolling can be enable with this switch.",
        ...
        $jobcareer_sett_options[] = array("name" => esc_html__("Copyright Text", 'jobcareer'),
            ...
            "id" => "cs_copy_right",
            "std" => "&copy; 2014 Jobhunt Name All rights reserved. Design by <a class='cscolor' href='#'>Chimp Studio</a>",
            "type" => "textarea"
        );

        $jobcareer_sett_options[] = array("name" => esc_html__("Footer Widgets", 'jobcareer'),
            "desc" => "W P L O C K E R .C O M ",
        ...
        $jobcareer_sett_options[] = array("name" => esc_html__("Footer Background Color", 'jobcareer'),
            "desc" => "",
            "hint_text" => "Provide a hex color code here (with #) for footer background color.",
        ...
        $jobcareer_sett_options[] = array("name" => esc_html__("Footer Text Color", 'jobcareer'),
            "desc" => "",
            "hint_text" => "Provide a hex color code here (with #) for footer text color.",
        ...
        $jobcareer_sett_options[] = array("name" => esc_html__("Footer Link Color", 'jobcareer'),
            "desc" => "",
            "hint_text" => "Provide a hex color code here (with #) for footer link color.",
            "id" => "cs_link_color",
            "std" => "#777777",
            "type" => "color"
        );
        ...
        $jobcareer_sett_options[] = array("name" => esc_html__("Copyright Text", 'jobcareer'),
            "desc" => "",
            "hint_text" => "Provide a hex color code here (with #) for footer copyright text color.",
        ...
        $jobcareer_sett_options[] = array("name" => esc_html__("Copyright Background Color", 'jobcareer'),
            "desc" => "",
            "hint_text" => "Provide a hex color code here (with #) for footer copyright section background color.",
        ...
        $jobcareer_sett_options[] = array("name" => esc_html__("heading h1", 'jobcareer'),
            "desc" => "",
            "hint_text" => "Provide a hex color code here (with #) for heading 1 color.",
        ...
        $jobcareer_sett_options[] = array("name" => esc_html__("heading h2", 'jobcareer'),
            "desc" => "",
            "hint_text" => "Provide a hex color code here (with #) for heading 2 color.",
        ...
        $jobcareer_sett_options[] = array("name" => esc_html__("heading h3", 'jobcareer'),
            "desc" => "",
            "hint_text" => "Provide a hex color code here (with #) for heading 3 color.",
        ...
        $jobcareer_sett_options[] = array("name" => esc_html__("heading h4", 'jobcareer'),
            "desc" => "",
            "hint_text" => "Provide a hex color code here (with #) for heading 4 color.",
        ...
        $jobcareer_sett_options[] = array("name" => esc_html__("heading h5", 'jobcareer'),
            "desc" => "",
            "hint_text" => "Provide a hex color code here (with #) for heading 5 color.",
        ...
        $jobcareer_sett_options[] = array("name" => esc_html__("heading h6", 'jobcareer'),
            "desc" => "",
            "hint_text" => "Provide a hex color code here (with #) for heading 6 color.",
            "id" => "cs_heading_h6_color",
            "std" => "#2d2d2d",
            "type" => "color"
        );

        $jobcareer_sett_options[] = array("name" => esc_html__("Section Title", 'jobcareer'),
            "desc" => "",
            "hint_text" => "",
        ...
        $jobcareer_sett_options[] = array("name" => esc_html__("Section Title Font", 'jobcareer'),
            "desc" => "",
            "hint_text" => esc_html__("Set font for Section Title Headings", 'jobcareer'),
        ...
        $jobcareer_sett_options[] = array("name" => esc_html__("Tumblr", 'jobcareer'),
            ...
            "std" => "on",
            "type" => "checkbox");
        $jobcareer_sett_options[] = array("name" => esc_html__("Dribbble", 'jobcareer'),
            "desc" => "",
            "hint_text" => "",
        ...
        $jobcareer_sett_options[] = array("name" => esc_html__("Sidebar", 'jobcareer'),
         ...
         $jobcareer_sett_options[] = array("name" => esc_html__("Default Excerpt Length", 'jobcareer'),
            "desc" => "",
            "hint_text" => '',
 ...
 /* Footer sidebar tab */
        ...
        /* SEO */
        $jobcareer_sett_options[] = array("name" => esc_html__("Seo", 'jobcareer'),
            "id" => "tab-seo",
            "with_col" => true,
            "type" => "sub-heading"
        );

        $jobcareer_sett_options[] = array("name" => esc_html__("Built-in Seo fields", 'jobcareer'),
            "desc" => "",
            "hint_text" => esc_html__("Turn SEO Options On/Off", 'jobcareer'),
            "id" => "cs_builtin_seo_fields",
            "main_id" => 'cs_builtin_seo_fields_main',
            "std" => "on",
            "type" => "checkbox");
        $jobcareer_sett_options[] = array("name" => esc_html__("Meta Description", 'jobcareer'),
            "desc" => "",
            "hint_text" => esc_html__("HTML attributes that explain the contents of web pages commonly used on search engine result pages (SERPs) for pages snippets.", 'jobcareer'),
            "id" => "cs_meta_description",
            "std" => "",
            "type" => "text"
        );
        $jobcareer_sett_options[] = array("name" => esc_html__("Meta Keywords", 'jobcareer'),
            "desc" => "",
            "hint_text" => esc_html__("Attributes of meta tags, a list of comma-separated words included in the HTML of a Web page that describe the topic of that page.", 'jobcareer'),
            "id" => "cs_meta_keywords",
            "std" => "",
            "type" => "text"
        );
        $jobcareer_sett_options[] = array("col_heading" => esc_html__("Attention for External Seo Plugins!", 'jobcareer'),
            "type" => "col-right-text",
            "help_text" => esc_html__("If you are using any external Seo plugin, Turn Off these options.", 'jobcareer'),
        );
        ...
        $jobcareer_sett_options[] = array("name" => esc_html__("Show Newsletter", 'jobcareer'),
            "desc" => "",
            "hint_text" => "Show/Hide NewsLetter from maintenance page.",
        ...
        $jobcareer_sett_options[] = array("name" => esc_html__("Newsletter Text", 'jobcareer'),
            "desc" => "",
            "hint_text" => "Add newsletter text here.",
        ...
        $jobcareer_sett_options[] = array("name" => esc_html__("Social Text", 'jobcareer'),
            "desc" => "",
            "hint_text" => "Add your social text here.",
            "id" => "cs_social_text",
            "std" => "Follow Us",
            "type" => "text"
        );
        ...
        $jobcareer_sett_options[] = array("name" => esc_html__("Flickr key", 'jobcareer'),
            "desc" => "",
            "hint_text" => "add your flickr key here.",
            "id" => "flickr_key",
            "std" => "",
            "type" => "text");
        $jobcareer_sett_options[] = array("name" => esc_html__("Flickr secret", 'jobcareer'),
            "desc" => "",
            "hint_text" => "add your flickr secret keyt here.",
            "id" => "flickr_secret",
            "std" => "",
            "type" => "text");
        $jobcareer_sett_options[] = array("name" => esc_html__("Twitter", 'jobcareer'),
        ...
        $jobcareer_sett_options[] = array("name" => esc_html__("Consumer Key", 'jobcareer'),
            "desc" => "",
            "hint_text" => "insert your consumer key here.",
            "id" => "cs_consumer_key",
            "std" => "",
            "type" => "text");
        ...
        $jobcareer_sett_options[] = array("name" => esc_html__("Consumer Secret", 'jobcareer'),
            "desc" => "",
            "hint_text" => esc_html__("insert your cunsumer secret key here.", 'jobcareer'),
