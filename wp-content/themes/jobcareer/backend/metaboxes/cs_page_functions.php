    ...
    function jobcareer_subheader_element() {
        ...
        $jobcareer_metaboxes->cs_form_select_render(
                array('name' => esc_html__('Choose Sub-header', 'jobcareer'),
                    ...
                    'help_text' => esc_html__("Choose subheader layout for this specefic post. Deafult subheader get settings from theme options that you saved for subheader. Custom have custom feilds with full control same like theme options you can manage for only this post. Revolution Slider enables slider in subheader. Map for show map in subheader and no subheader for disbale subheader for this post.", 'jobcareer'),
                )
        );
        ...
        $jobcareer_metaboxes->cs_form_textarea_render(
                array('name' => esc_html__('Sub Heading', 'jobcareer'),
                    ...
                    'description' => '',
                    'hint' => '',
                    'help_text' => esc_html__("Enter subheading text here.it will display after title", 'jobcareer'),
                )
        );
        ...
        $jobcareer_metaboxes->cs_form_range_render(
                array('name' => esc_html__('Padding Top', 'jobcareer'),
                    ...
                    'std' => '0',
                    'description' => '',
                    'help_text' => esc_html__("Set padding top here.it affects before title", 'jobcareer'),
                )
        );
        ...
        $jobcareer_metaboxes->cs_form_range_render(
                array('name' => esc_html__('Padding Bottom', 'jobcareer'),
                    ...
                    'std' => '0',
                    'description' => '',
                    'help_text' => esc_html__("Set padding bottom here.it affects after title.", 'jobcareer'),
                )
        );
        ...
        $jobcareer_metaboxes->cs_form_checkbox_render(
                array('name' => esc_html__('Show Image', 'jobcareer'),
                    ...
                    'description' => '',
                    'hint' => '',
                    'help_text' => 'On this switch for showing backgournd image.',
                )
        );
        ...
        $jobcareer_metaboxes->cs_form_textarea_render(
                array('name' => esc_html__('Custom Map Short Code', 'jobcareer'),
                    ...
                    'description' => '',
                    'hint' => '',
                    'help_text' => 'Add/Edit the shortcode of map.',
                )
        );
        $jobcareer_metaboxes->cs_wrapper_end_render(
                array('name' => esc_html__('Wrapper', 'jobcareer'),
    ...
    function jobcareer_sidebar_layout_options() {
        ...
        if (isset($cs_page_layout) && $cs_page_layout != '') {
            ...
            if (isset($post->post_type) && $post->post_type == "post") {
                $selected = $jobcareer_options['cs_single_layout_sidebar'];
            } else {
                $selected = $jobcareer_options['cs_default_layout_sidebar'];
            }
        }
        ...
        $jobcareer_metaboxes->cs_form_layout_render(
                array('name' => esc_html__('Choose Sidebar', 'jobcareer'),
                    ...
                    'status' => '',
                    'meta' => '',
                    'help_text' => 'Choose sidebar layout for this post.'
                )
        );
        ...
        $jobcareer_metaboxes->cs_form_hidden_render(
                array('id' => esc_html__('orderby', 'jobcareer'),
                    'classes' => '',
                    'std' => 'meta_layout',
...
if (!function_exists('jobcareer_upcoming_element')) {
    ...
    function jobcareer_upcoming_element() {
        ...
        $cs_opt_array = array(
            ...
            'desc' => '',
            'echo' => true,
            'hint_text' => 'On this switch for showing Coming Soon page',
            'field_params' => array(
                'std' => '',
                'id' => 'page_upcoming',
                'prefix_enable' => true,
                'cust_name' => 'page_upcoming',
                'return' => true,
            ),
        );
        ...
        echo '<ul class="form-elements"><li class="to-label">' . esc_html__("Upcoming Page Content", 'jobcareer') . jobcareer_tooltip_text('This Content will print on frontend when employer post a new job as confirmation content on payment page.') . '
