    ...
    function jobcareer_post_options() {
        ...
        $jobcareer_metaboxes->cs_form_select_render(
                array('name' => esc_html__('Thumbnail View demo', 'jobcareer'),
                    ...
                    'status' => '',
                    'description' => '',
                    'help_text' => 'Choose thumbnial view type for this post. None for no image. Single image for display featured image on listings and slider for display slides on thumbnail view.',
        ...
        $jobcareer_metaboxes->cs_form_select_render(
                array('name' => esc_html__('Inside Post Thumbnail View', 'jobcareer'),
                    ...
                    'status' => '',
                    'description' => '',
                    'help_text' => 'Choose inside thumbnial view type for this post. None for no image. Single image for display featured image on detail. Slider for display slides on detail. Audio for make this audio post and video for display video inside post.',
        ...
        $jobcareer_metaboxes->cs_media_url(
                array('name' => esc_html__('Audio Url', 'jobcareer'),
                    ...
                    'description' => '',
                    'hint' => '',
                    'help_text' => 'Enter audio url for this post or upload new with this browse button.',
                )
        );
        $jobcareer_metaboxes->cs_wrapper_end_render(
                array('name' => esc_html__('Wrapper', 'jobcareer'),
        ...
        $jobcareer_metaboxes->cs_media_url(
                array('name' => esc_html__('Thumbnail Video Url', 'jobcareer'),
                    ...
                    'description' => '',
                    'hint' => '',
                    'help_text' => 'Enter Specific Video Url (Youtube, Vimeo and Dailymotion) OR you can select it from your media library',
                )
        );
    ...
    function jobcareer_general_settings_element() {
        ...
        $jobcareer_metaboxes->cs_form_checkbox_render(
                array('name' => esc_html__('Social Sharing', 'jobcareer'),
                    ...
                    'description' => '',
                    'hint' => '',
                    'help_text' => 'ON/OFF social sharing for this post.'
                )
        );
        $jobcareer_metaboxes->cs_form_checkbox_render(
                array('name' => esc_html__('Tags', 'jobcareer'),
                    ...
                    'description' => '',
                    'hint' => '',
                    'help_text' => 'ON/OFF tags from frontend for this post.'
                )
        );
        ...
        $jobcareer_metaboxes->cs_form_checkbox_render(
                array('name' => esc_html__('Related Post', 'jobcareer'),
                    ...
                    'description' => '',
                    'hint' => '',
                    'help_text' => 'Enable/Disable related post on detail page.'
                )
        );
    }
