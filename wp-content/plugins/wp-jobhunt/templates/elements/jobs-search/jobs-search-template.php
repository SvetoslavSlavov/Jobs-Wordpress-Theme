...
if (!function_exists('cs_job_search_box')) {
    ...
    function cs_job_search_box($atts, $content = "") {
        ...
        if (isset($job_search_layout_bg) && ($job_search_layout_bg != '' && $job_search_layout_bg != 'none')) {
            echo ' class="main-search has-bgcolor" style="background:' . esc_attr($job_search_layout_bg) . ' !important;"';
        } else {
            ...
            <div class="row">
                ...
                if ($search_result_page_id != '') { // search result page 
                    ...
                    <form id="frm_jobs_filtration" action="<?php echo esc_url(get_permalink($search_result_page_id)); ?>" method="get"  class="search-area">
                            ...
                            <div class="col-lg-4 col-md-3 col-sm-6">
                                ...
                                <div class="search-input"> <i class="icon-search7"></i>
                                    ...
                                    <?php if ($job_search_hint_switch == 'yes') { ?>
                                        <label><?php _e('Job title, skills, or keywords', 'jobhunt') ?></label> 
                                    <?php } ?>
                                </div>
                            </div> 
                        <?php } ?>
                        <?php if ($specialisam_field_switch == 'yes') { ?>  
                            <div class="col-lg-3 col-md-4 col-sm-6">
                                <?php if ($job_lable_switch == 'yes') { ?>
                                    <span class="search_title"><?php _e('Specialisam ', 'jobhunt') ?></span>
                                <?php } ?>
                                <div class="select-dropdown">
                                    ...
                                    ?>
                                    <?php if ($job_search_hint_switch == 'yes') { ?>
                                        <label><?php _e("Jobs by selecting 'specialisms'", 'jobhunt') ?></label>
                                    <?php } ?>
                                </div>
                            </div>
                            <?php
                            ...
                            <div class="col-lg-2 col-md-2 col-sm-6">
                                ...
                                <div class="search-btn">
                                    ...
                                    if ($job_advance_search_switch == 'yes') {
                                        ?>
                                        <label>
                                            <a href="<?php echo esc_url($job_advance_search_url); ?>"  target="_blank">
                                                <?php _e("+ Advance Search", "jobshunt") ?>
                                            </a>
                                        </label>
                                    <?php } ?>
                                </div>
                    ...
                    if (isset( $full_view ) && $full_view == true) {
                        ...
                        <div class="container">
                        <?php }
                        ?><h2><?php _e("*Please follow the given guide and select 'Search Result Page' first", 'jobhunt') ?></h2><?php
                        if (isset( $full_view ) && $full_view == true) {
                            ?></div><?php
                    }
                }
