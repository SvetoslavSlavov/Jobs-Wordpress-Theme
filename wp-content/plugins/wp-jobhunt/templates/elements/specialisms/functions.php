    ...
    function cs_job_specialisms_shortcode($atts) {
        ...
        $cs_html .= '
			 <div class="col-lg-12 col-md-12 col-sm-12">
			   <div class="cs-section-title"><h2>' . $job_specialisms_title . '</h2><span>' . sprintf(__('%s jobs live - %s added today.', 'jobhunt'), absint($cs_total_jobs), sizeof($get_today_job)) . '</span></div>
			 </div>';
        $cs_html .= $cs_li_html;
        $cs_html .= '
			</div>
...
/*
 *
 * End Function how to create shortcode of job_specialisms
 *
 */