...
if (!function_exists('cs_element_list')) {
    ...
    function cs_element_list() {
        ...
        $element_list['element_list'] = array(
            ...
            'audio' => __('Audio', 'jobs'),
            'icons' => __('Icons', 'jobs'),
            'contactus' => __('Contact Us', 'jobhunt'),
            'tooltip' => __('Tooltip', 'jobhunt'),
            'services' => __('Services', 'jobhunt'),
            'multiple services' => __('Multiple Services', 'jobhunt'),
            ...
            'multiple_services' => __('Multiple Services', 'jobhunt'),
            ...
            'multi_counters' => __('Multi Counter', 'jobhunt'),
            'multi counters' => __('Multi Counter', 'jobhunt'),
            'portfolio' => __('Portfolio', 'jobs'),
