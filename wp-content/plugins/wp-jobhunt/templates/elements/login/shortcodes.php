    ...
    function cs_register_shortcode($atts, $content = "") {
        ...
        if (is_user_logged_in()) {
            $output .='<div class="alert alert-warning">' .
                    __('You have already logged in, Please logout to try again.', 'jobhunt') . '<a data-dismiss="alert" class="close" href="#">×</a>'
                    . '</div>';
        }
        ...
        $output .= '<div class="col-md-6 login-section">
        ...
        if ($isRegistrationOn) {
            ...
            $cs_opt_array = array(
                ...
                'extra_atr' => ' size="20" tabindex="101" placeholder="Username"',
                'classes' => 'form-control',
                'return' => true,
            );
            $output .= $cs_form_fields2->cs_form_text_render($cs_opt_array);
            ...
            $cs_rand_value = rand(54654, 9999996546546);
            ...
            if ($cs_captcha_switch == 'on' && (!is_user_logged_in())) {
                $output .='<div class="col-md-12 recaptcha-reload" id="recaptcha2_div">';
                    ...
                    if ($isRegistrationOn) {
                        ...
                        $output .= $cs_form_fields2->cs_form_text_render(
                                array('name' => __('Organization Name', 'jobhunt'),
                                    ...
                                    'std' => '',
                                    'extra_atr' => ' placeholder="'.__('Orgnization Name', 'jobhunt').'"',
                                    'return' => true,
                                )
                        );
                        $output .= '</label>';
