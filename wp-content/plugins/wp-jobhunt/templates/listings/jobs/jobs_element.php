        ...
        ?>" item="jobs" data="<?php echo element_size_data_array_index($jobs_element_size) ?>">
            ...
            <div class="cs-wrapp-class-<?php echo intval($cs_counter); ?> <?php echo esc_attr($shortcode_element); ?>" id="<?php echo esc_attr($name . $cs_counter); ?>" data-shortcode-template="[cs_jobs {{attributes}}]"  style="display: none;">
                <div class="cs-heading-area">
                    <h5><?php _e('EDIT JOB OPTIONS', 'jobhunt') ?></h5>
                ...
                <div class="cs-pbwp-content">
                    <div class="cs-wrapp-clone cs-shortcode-wrapp">
                        ...
                        $cs_opt_array = array(
                            ...
                            'desc' => '',
                            'hint_text' => __("Choose top content of section with drop down section title, total rocords with title and filters can be select..", "jobhunt"),
                            'echo' => true,
                            'field_params' => array(
                                ...
                                'options' => array(
                                    ...
                                    'section_title' => __('Section Title', 'jobhunt'),
