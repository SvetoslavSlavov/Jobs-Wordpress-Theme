...
//                                            $cs_employee_address = get_post_meta($employer_post->ID, 'cs_post_comp_address', true);
//                                            $cs_employee_web_http = get_post_meta($employer_post->ID, 'cs_website', true);
//                                            $cs_employee_web = preg_replace('#^https?://#', '', $cs_employee_web_http);
//                                            $cs_employee_facebook = get_post_meta($employer_post->ID, 'cs_facebook', true);
//                                            $cs_employee_twitter = get_post_meta($employer_post->ID, 'cs_twitter', true);
//                                            $cs_employee_linkedin = get_post_meta($employer_post->ID, 'cs_linkedin', true);
//                                            $cs_employee_google_plus = get_post_meta($employer_post->ID, 'cs_google_plus', true);
//
//                                            $cs_job_employer = get_post_meta($post->ID, "cs_job_username", true); //
//                                            $cs_employee_employer_img = get_the_author_meta('user_img', $cs_job_employer);
//                                            $cs_employee_address = get_user_address_string_for_list($cs_job_employer, 'usermeta');
//
//
//                                            $cs_employee_employer_img = get_post_meta($employer_post->ID, 'employer_img', true);
//                                            $cs_employee_employer_img = cs_get_img_url($cs_employee_employer_img, 'cs_media_5');
//                                            $cs_phone_number = get_post_meta($employer_post->ID, 'cs_phone_number', true);
//                                            $cs_email = get_post_meta($employer_post->ID, 'cs_email', true);
...
//                                            }
//                                            $cs_employee_emp_username = get_post_meta($employer_post->ID, 'cs_user', true);
                                            ...
                                            <div class="jobs-info">
                                                <div class="cs-text">
                                                    ...
                                                    <h2><?php echo get_the_title($job_post->ID) ?></h2>
                                                    <ul class="post-options">
                                                        ...
                                                        <?php if ($cs_employee_address <> '') {
                                                            ?>
                                                            <li><i class="icon-location6"></i><a href="#"><?php echo esc_html($cs_employee_address); ?></a></li>
                                                            <?php
                                                        }
                                                        $cs_job_posted_date = get_post_meta($job_post->ID, 'cs_job_posted', true);
                                                        if (isset($cs_job_posted_date) && $cs_job_posted_date != '') {
                                                            ?>
                                                            <li><i class="icon-clock3"></i><?php _e("Post date", "jobhunt"); ?>  <span><?php echo date_i18n(get_option('date_format'), (get_post_meta($job_post->ID, 'cs_job_posted', true))); ?></span></li>
                                                        <?php }
                                                        ?>
                                                    </ul>
                                                    <?php
                                                        ...
                                                        if (isset($user_role) && $user_role <> '' && $user_role == 'cs_candidate') {
                                                            ...
                                                            if (isset($user) and $user <> '' and is_user_logged_in()) {
                                                                ...
                                                                if (is_array($finded_result_list) && !empty($finded_result_list)) {
                                                                    ?>
                                                                    <a class="btn large like applied_icon" onclick="cs_removejobs_left_to_applied('<?php echo esc_url(admin_url('admin-ajax.php')); ?>', '<?php echo intval($job_post->ID); ?>', this)" >
                                ...
                                <div class="row">
                                                ...
                                                if (is_array($cs_job_cus_fields) && sizeof($cs_job_cus_fields) > 0) {
                                                    ...
                                                    foreach ($cs_job_cus_fields as $cus_field) {
                                                        if ($cus_field['meta_key'] != '') {
                                                            ...
                                                            if ($cus_field['label'] != '')
                                                                if ($data != "") {
                                                                    ?> <li class="col-lg-6 col-md-6 col-sm-12"><div class="listing-inner">
                                    ...
                                    <aside class="col-lg-4 col-md-4 col-sm-6 section-sidebar">
                                        <div class="employer-contact-form">
                                            ...
                                            <div id="ajaxcontact-response" class="error-msg"></div>
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    if ($post_loc_latitude != '' && $post_loc_latitude != '') {
                                        /* echo do_shortcode('[cs_map column_size="1/1" map_lat="' . $post_loc_latitude . '" map_lon="' . $post_loc_longitude . '"
                                          ...
                                          map_show_marker="true" map_info="' . preg_replace("/\r|\n/", "", $cs_employee_address) . '"  map_controls="true" map_draggable="true" map_scrollwheel="true" map_border="yes"]');
