                    ...
                    <div class="<?php if (isset($cs_plugin_options['cs_plugin_single_container']) && $cs_plugin_options['cs_plugin_single_container'] == 'on') echo 'container' ?>">
                        <div class="row">
                            <div class="section-fullwidtht col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="row">
                                    <div class="section-content col-lg-8 col-md-8 col-sm-12">
                                        <div class="jobs-info">
                                            <div class="cs-text">
                                                <?php
                                                ...
                                                if ($all_job_type != '') {
                                                    foreach ($all_job_type as $job_type) {
                                                        ...
                                                        $job_type_values .= '<a href="' . esc_url($cs_link) . '" class="freelance" style="border-color:' . $job_type_color . '">' . $job_type->name . '</a>';
                                    ...
                                    <div class="section-sidebar col-lg-4 col-md-4 col-sm-6">
                                        <?php
                                        $flag = 1;
                                        if (isset($employer_post) && $employer_post != '') {
//                                            $cs_employee_address = get_post_meta($employer_post->ID, 'cs_post_loc_address', true);
...
//                                            $cs_employee_employer_img = get_the_author_meta('user_img', $cs_job_username);
...
//                                            $cs_employee_emp_username = get_post_meta($employer_post->ID, 'cs_user', true);
                                            ...
                                            <div class="company-info">
                                                ...
                                                <div class="cs-text">
                                                    ...
                                                    <div class="btn-area">
                                                        <a href="<?php echo esc_url(get_author_posts_url($employer_post->ID)); ?>">View all Jobs</a>
                                        ...
                                        <div class="widget widget-jobs">
                                            ...
                                            if ($custom_query->have_posts() <> "") {
                                                ?>
                                                <div class="widget-title"><h5><?php _e("Related Jobs"); ?></h5></div>
                                                <ul>
                                                    <?php
                                                    global $cs_plugin_options;
