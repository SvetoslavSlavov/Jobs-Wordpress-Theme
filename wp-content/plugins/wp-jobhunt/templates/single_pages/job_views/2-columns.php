        ...
        while (have_posts()) : the_post();
            ...
            <div class="main-section jobs-detail-4">
                ...
                <div class="page-section">
                    <div class="<?php if (isset($cs_plugin_options['cs_plugin_single_container']) && $cs_plugin_options['cs_plugin_single_container'] == 'on') echo 'container' ?>">
                        <div class="row">
                            <div class="section-content col-lg-6 col-md-6 col-sm-12">
            ...
            <?php } ?>
                            ...
                            <div class="section-sidebar col-lg-6 col-md-6 col-sm-12">
                ...
                <?php } ?>
                                ...
                                if ($post_loc_latitude != '' && $post_loc_latitude != '') {
                                    ...
                                    <div class="map-sec">
                                        <?php
                                        /*
                                          echo do_shortcode('[cs_map column_size="1/1" map_height="250" map_lat="' . $post_loc_latitude . '" map_lon="' . $post_loc_longitude . '" '
                                          . 'map_zoom="11" map_type="ROADMAP" map_info="' . preg_replace( "/\r|\n/", "", $cs_employee_address ) . '" '
                                          . 'map_info_width="250" map_info_height="100" map_marker_icon1xis="Browse" map_show_marker="true" map_controls="false" '
                                          . 'map_draggable="true" map_scrollwheel="true" map_border="yes" cs_map_style="style-1"]');
                                         * 
                                         */
                                        $arg = array(
                                            'map_height' => '250',
                                            ...
                                            'map_info_width' => '250',
                                            'map_info_height' => '100',
                                            'map_marker_icon1xis' => 'Browse',
                                            'map_show_marker' => 'true',
                                            'map_controls' => 'false',
                                            'map_draggable' => 'true',
                                            'map_scrollwheel' => 'true',
                                            'map_border' => 'yes',
                                            'cs_map_style' => 'style-1',
                                        );
