                    ...
                    <div class="dashboard-content-holder">
                        <div class="cs-account-info">
                            ...
                            <div class="cs-img-detail">
                                    ...
                                    <div class="page-wrap" id="cs_employer_img_box">
                                        <figure>
                                            ...
                                            if ($cs_value <> '') {
                                                ...
                                                $cs_value = cs_get_img_url($cs_value, 'cs_media_4');
                                                ?>
                                ...
                                <div class="upload-btn-div">
                                    <div class="fileUpload uplaod-btn btn cs-color csborder-color">
                                        <span><?php _e('Browse', 'jobhunt'); ?></span>
                                        <?php
                                        $cs_opt_array = array(
                                            'std' => $imagename_only,
                                            'id' => '',
                            ...
                            <div class="cs-img-detail">
                                ...
                                <div class="upload-btn-div">
                                    <div class="fileUpload uplaod-btn btn cs-color csborder-color">
                                        <span><?php _e('Browse Cover', 'jobhunt'); ?></span>
                                        <?php
                                        $cs_opt_array = array(
                            ...
                            <div class="input-info">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        wp_editor($cs_comp_detail, 'comp_detail', array(
                            ...
                            <div class="input-info">
                                <div class="row">
                                    <div class="social-media-info">
                                        <div class="social-input col-md-6">
                                            <?php
                                            $cs_opt_array = array(
                                                'id' => 'facebook',
                                                'std' => $cs_facebook,
            ...
            if ($uid != '') {
                ...
                <div class="cs-manage-jobs">
                    ...
                    if ($cs_emp_dashboard != '') {
                        ...
                        $cs_employer_link = "http://" . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI'];
                    }
                    $cs_blog_num_post = 10;
                    ...
                    ?>
                    <div class="scetion-title">
                        <h4><?php _e('Manage Jobs', 'jobhunt') ?></h4>
                    </div>
                    <?php
                                ...
                                while ($custom_query->have_posts()) : $custom_query->the_post();
                                    ...
                                    <li>
                                        <div class="manag-title">
                                            ...
                                            ?>
                                            <div class="last-update"><?php echo _("Last Update:") ?> <span><?php the_modified_date(); ?></span></div>
                                        </div>
        ...
        public function cs_ajax_trans_history() {
            ...
            if ($uid != '') {
                ...
                <div class="cs-transection">
                    <div class="scetion-title">
                        <h4><?php _e('Transactions', 'jobhunt') ?></h4>
                    </div>
                    <?php
                    if ($custom_query->have_posts()) {
                        ?>
                            ...
                            <ul class="transaction-list">
                                ...
                                while ($custom_query->have_posts()) : $custom_query->the_post();
                                    ...
                                    <li>
                                        ...
                                        <div class="trans-description"><span>&nbsp;<?php echo esc_attr($cs_trans_pkg_title) ?></span></div>
            ...
            if ($uid != '') {
                if ($cs_candidate_switch == 'on') {    // paid list
                    ...
                    if (!empty($cs_fav_resumes))
                        $cs_fav_resumes = array_column_by_two_dimensional($cs_fav_resumes, 'post_id');
                    else
                            ...
                            <ul class="resumes-list">
                                ...
                                foreach ($custom_query->results as $cs_user) {
                                    ...
                                    <li>
                                        ...
                                        <a data-toggle="tooltip" data-placement="top" title="<?php echo __("Remove", "jobhunt"); ?>" class="delete" id="cs-resume-<?php echo absint($cs_fav) ?>" onclick="cs_fav_resume_del('<?php echo esc_js(admin_url('admin-ajax.php')); ?>', '<?php echo absint($cs_fav) ?>')"><i class="icon-trash-o"></i></a>
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                        <?php
                                                        $contact_heading = '<h4>'.__('Send message To Jon Candidate</h4>', 'jobhunt');
                                                        if (get_the_title($cs_fav) != "") {
                                                            $contact_heading = '<h4>'.__('Send message To "', 'jobhunt') . get_the_title($cs_fav) . '"</h4>';
                                                        }
                                                        echo $contact_heading;
                                                        ?> 
                                                    </div>
                                                    <div class="modal-body">
                                                        <div id="cs_employer_id_<?php echo absint($cs_fav) ?>" data-validationmsg="<?php _e("Please ensure that all required fields are completed and formatted correctly", "jobs"); ?>">
                                                            ...
                                                            <div class="cs-profile-contact-detail">
                                                                <form id="ajaxcontactform-<?php echo absint($cs_fav) ?>"  method="post" enctype="multipart/form-data">
                                                                    ...
                                                                    <div class="input-filed-contact">
                                                                        ...
                                                                        <?php
                                                                        $ajaxcontactphone = isset($ajaxcontactphone) ? $ajaxcontactphone : '';
                    ...
                    if (isset($cs_trnas_html) && $cs_trnas_html != '') {
                        ...
                        if ($cs_total_amount > 0) {
                            ...
                            if ($cs_vat_switch == 'on' && isset($cs_vat_amount)) {
                                $cs_html .= '
											<li><span>' . sprintf(__('VAT (%s&#37;)', 'jobhunt'), $cs_pay_vat) . '</span><em>' . esc_attr($currency_sign) . CS_FUNCTIONS()->cs_num_format($cs_vat_amount) . '</em></li>';
                            }
