                    ...
                    <section class="cs-profile-info">
                        <div class="cs-img-detail">
                            <div class="alert alert-dismissible user-img"> 
                                <div class="page-wrap" id="cs_user_img_box">
                                    <figure>
                                        <?php
                                        if ($cs_value <> '') {
                                            $cs_value = cs_get_image_url($cs_value, 'cs_media_4');
                                            ?>
                            ...
                            <div class="upload-btn-div">
                                ...
                                <br />
                                <span class="cs-color" id="cs_candidate_profile_img_msg"><?php _e('Max file size is 1MB, Minimum dimension: 270x210 And Suitable files are .jpg & .png', 'jobhunt'); ?></span>
                            </div>
                        </div>
                        <div class="input-info">
                            <div class="row">
                                <div class="col-md-12">
                                    <label><?php _e('Title', 'jobhunt'); ?></label>
                                    <?php
                                    $cs_opt_array = array(
    ...
    function cs_ajax_candidate_favjobs($uid = '') {
        ...
        if ($uid <> '') {
            ...
            <section class="cs-favorite-jobs">
                ...
                ?>
                <div class="scetion-title">
                    <h5><?php _e('Shortlisted jobs', 'jobhunt'); ?></h5>
                </div>
...
if (!function_exists('cs_ajax_candidate_appliedjobs')) {
    ...
    function cs_ajax_candidate_appliedjobs($uid = '') {
        ...
        if ($uid <> '') {
            ...
            <section class="cs-favorite-jobs">
                <div class="scetion-title">
                    <h5><?php _e('Applied Jobs', 'jobhunt'); ?></h5>
                    <?php
                    $args = array(
...
if (!function_exists('cs_ajax_candidate_cvcover')) {
    ...
    function cs_ajax_candidate_cvcover($uid = '') {
        ...
        <section class="cs-cover-letter">
            <div class="scetion-title">
                <h5><?php _e('CV &amp; Cover Letter', 'jobhunt'); ?> </h5>
            </div>
            <div class="dashboard-content-holder">
                <form id="candidate_cv" name="cs_candidate"  enctype="multipart/form-data" method="POST">
                    ...
                    wp_editor($cs_cover_letter, 'cs_cover_letter', array(
                        'textarea_name' => 'cs_cover_letter',
                        'editor_class' => 'text-input',
                        'teeny' => true,
                        'media_buttons' => false,
                        'textarea_rows' => 6,
                    ...
                    ?><script type="text/javascript">
                                var str = et_tinyMCEPreInit.replace(/cs_comp_init_detail/gi, 'cs_cover_letter');
