				...
				function updatePredictions(predictions, status) {
					...
					if (google.maps.places.PlacesServiceStatus.OK == status) {
						...
						jQuery.each(predictions, function (i, prediction) {
							google_results += '<div class="cs_google_suggestions">' + jQuery.fn.cityAutocomplete.transliterate(prediction.description) + '<span style="display:none">' + jQuery.fn.cityAutocomplete.transliterate(prediction.description) + '</span></div>';
						});
						request_var = 0;
					} else {
