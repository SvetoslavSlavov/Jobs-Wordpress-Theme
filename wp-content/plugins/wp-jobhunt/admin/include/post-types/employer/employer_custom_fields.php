    ...
    class cs_employer_custom_fields_options {
        ...
        public function jobcareer_pb_employer_text($die = 0, $cs_return = false) {
            ...
            if (isset($cs_employer_cus_fields[$cs_counter])) {
                $cs_title = isset($cs_employer_cus_fields[$cs_counter]['label']) ? sprintf(__('Text : %s', 'jobhunt'), $cs_employer_cus_fields[$cs_counter]['label']) : '';
            } else {
        ...
        /**
         * end How to add Employer Text Fields Function
         */
        ...
        public function jobcareer_pb_employer_textarea($die = 0, $cs_return = false) {
            ...
            if (isset($cs_employer_cus_fields[$cs_counter])) {
                $cs_title = isset($cs_employer_cus_fields[$cs_counter]['label']) ? sprintf(__('Text Area : %s', 'jobhunt'), $cs_employer_cus_fields[$cs_counter]['label']) : '';
            } else {
        ...
        public function jobcareer_pb_employer_dropdown($die = 0, $cs_return = false) {
            ...
            if (isset($cs_employer_cus_fields[$cs_counter])) {
                $cs_title = isset($cs_employer_cus_fields[$cs_counter]['label']) ? sprintf(__('Dropdown : %s', 'jobhunt'), $cs_employer_cus_fields[$cs_counter]['label']) : '';
            } else {
        ...
        /**
         * end How to add Dropdown in  Employer Function
         */
        ...
        public function jobcareer_pb_employer_date($die = 0, $cs_return = false) {
            ...
            if (isset($cs_employer_cus_fields[$cs_counter])) {
                $cs_title = isset($cs_employer_cus_fields[$cs_counter]['label']) ? sprintf(__('Date : %s', 'jobhunt'), $cs_employer_cus_fields[$cs_counter]['label']) : '';
            } else {
        ...
        /**
         * End How to add Custom field in  Employer Function
         */
        ...
        public function jobcareer_pb_employer_email($die = 0, $cs_return = false) {
            ...
            if (isset($cs_employer_cus_fields[$cs_counter])) {
                $cs_title = isset($cs_employer_cus_fields[$cs_counter]['label']) ? sprintf(__('Email : %s', 'jobhunt'), $cs_employer_cus_fields[$cs_counter]['label']) : '';
            } else {
        ...
        /**
         * End Function How to add email fields  in  Employer from 
         */
        ...
        public function jobcareer_pb_employer_url($die = 0, $cs_return = false) {
            ...
            if (isset($cs_employer_cus_fields[$cs_counter])) {
                $cs_title = isset($cs_employer_cus_fields[$cs_counter]['label']) ? sprintf(__('Url : %s', 'jobhunt'), $cs_employer_cus_fields[$cs_counter]['label']) : '';
            } else {
        ...
        /**
         * End Function How to add employer custom fields  Employer from 
         */
        ...
        public function jobcareer_pb_employer_range($die = 0, $cs_return = false) {
            ...
            if (isset($cs_employer_cus_fields[$cs_counter])) {
                $cs_title = isset($cs_employer_cus_fields[$cs_counter]['label']) ? sprintf(__('Range : %s', 'jobhunt'), $cs_employer_cus_fields[$cs_counter]['label']) : '';
            } else {
        ...
        /**
         * End Function How to add employer range In  Employer from 
         */
        ...
        /**
         * End Function add custom fields in employer form
         */
        ...
        /**
         * End Function how to input textarea in employer form
         */
        ...
        /**
         * End Function how to Select fields in  employer form
         */
        ...
        public function cs_update_custom_fields() {
            ...
            if (isset($_POST['cs_employer_cus_field_id']) && sizeof($_POST['cs_employer_cus_field_id']) > 0) {
                foreach ($_POST['cs_employer_cus_field_id'] as $keys => $values) {
                    if ($values != '') {
                        ...
                        switch ($cs_type) {
                            ...
                            case('dropdown'):
                                ...
                                if (isset($_POST["employer_cus_field_{$cs_type}"]['options_values'][$values]) && (strlen(implode($_POST["employer_cus_field_{$cs_type}"]['options_values'][$values])) != 0)) {
                                    ...
                                    $error = 1;
                                    $error_msg .= sprintf(__("Please select atleast one option for '%s' field.", 'jobhunt'), $employer_cus_field_array['label']);
                                }
                                $dropdown_counter++;
                                break;
                            case('date'):
                        ...
                        $employer_cus_field[$values] = $employer_cus_field_array;
            ...
            if ($error == 0) {
                ...
                $error = 0;
                $error_msg = __('All Settings Saved', 'jobhunt');
            }
        ...
        /**
         * End Function how to Check employer form fields in  employer form
         */
    }
