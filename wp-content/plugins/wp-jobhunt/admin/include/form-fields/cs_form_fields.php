...
if (!class_exists('cs_form_fields2')) {
    ...
    class cs_form_fields2 {
        ...
        public function cs_media_url($params = '') {
            ...
            $cs_output .= '<input type="button" ' . $html_id_btn . $html_name . ' class="uploadfile left" value="' . __('Browse', 'jobdoor') . '"/>';
            $cs_output .= '</label>';
        ...
        public function cs_form_fileupload_render($params = '') {
            ...
            $cs_output .= '<label' . $display_btn . ' class="browse-icon"><input' . $btn_name . 'type="button" class="cs-uploadMedia left" value=' . __("Browse", "jobdoor") . ' /></label>';
        ...
        public function cs_form_custom_fileupload_render($params = '') {
            ...
            $cs_output .= '<label' . $display_btn . ' class="browse-icon"><input' . $btn_name . 'type="file" class="'.$cs_classes.'" value=' . __("Browse", "jobdoor") . ' /></label>';
        ...
        public function cs_form_cvupload_render($params = '') {
            ...
            $cs_output .= '<input' . $html_id . $html_name . 'type="hidden" class="" value="' . $value . '"/>';
            $cs_output .= '<label class="browse-icon"><input' . $btn_name . 'type="button" class="cs-uploadMedia left" value="' . __("Browse", "jobdoor") . '" /></label>';
