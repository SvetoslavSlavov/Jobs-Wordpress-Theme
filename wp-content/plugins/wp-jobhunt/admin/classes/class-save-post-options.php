                                                ...
                                                <div class="select-holder">
                                                    ...
                                                    $cs_opt_array = array(
                                                        ...
                                                        'field_params' => array(
                                                            ...
                                                            'id' => 'loc_country',
                                                            'cust_id' => 'loc_country',
                                                            'extra_atr' => 'data-placeholder="' . __("Select Country", "jobhunt") . '"',
                                                            'cust_name' => 'cs_post_loc_country',
                            ...
                            <div class="form-field">
                                <ul class="form-elements" style="margin:0; padding:0;">
                                    <li class="to-field" style="width:100%;">
                                        <label style="width:100%;"><?php _e("Image", "jobhunt"); ?></label>
                                        <?php
                                        $cs_opt_array = array(
                                            'id' => '',
                                ...
                                <p><?php _e("Image for Specialisms", "jobhunt"); ?></p>
                            </div>
                            <?php
                            $cs_opt_array = array(
                                'id' => '',
                                ...
                                <td>
                                    <ul class="form-elements" style="margin:0; padding:0;">
                                        <li class="to-field" style="width:100%;">
                                            ...
                                            <div class="page-wrap" style="overflow:hidden; display:<?php echo esc_attr($spec_image) && trim($spec_image) != '' ? 'inline' : 'none'; ?>" id="spec_image<?php echo esc_attr($cs_counter) ?>_box" >
                                                <div class="gal-active" style="padding-left:0 !important;">
                                                    <div class="dragareamain" style="padding-bottom:0px;">
                                                        <ul id="gal-sortable" style="width:200px;">
                                                            <li class="ui-state-default" id="">
