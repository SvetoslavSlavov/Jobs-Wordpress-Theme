    ...
    class contactinfo extends WP_Widget {
        ...
        public function __construct() {
            parent::__construct(
                    ...
                    array('classname' => 'widget-text', 'description' => __('Enter info ', 'jobhunt'),)
            );
        }
                ...
                <div class="widgettext">                    
                    ...
                    <address>
                        <span> 
                            ...
                            echo ($title);
                            '<br />';
                            _e('Telephone: ', 'jobhunt');
                            echo esc_attr($telephone);
                            ?><br>
                            <?php _e('E-mail: ', 'jobhunt');
                            echo esc_attr($email);
                            ?>
                        </span>
                    </address>
